...
class Dashboard_direktur_psds_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Direktur PSDS KP';
		$this->data['left_menu'] = "dashboard_direktur_psds_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_direktur_psds_kp/content_dashboard_direktur_psds');
