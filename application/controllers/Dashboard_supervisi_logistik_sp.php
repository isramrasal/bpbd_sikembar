...
class Dashboard_supervisi_logistik_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Supervisi logistik SP';
		$this->data['left_menu'] = "dashboard_supervisi_logistik_sp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_supervisi_logistik_sp/content_dashboard_supervisi_logistik_sp');
