...
class Dashboard_manajer_konstruksi_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Manajer Konstruksi KP';
		$this->data['left_menu'] = "dashboard_manajer_konstruksi_kp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_manajer_konstruksi_kp/content_dashboard_manajer_konstruksi_kp');
