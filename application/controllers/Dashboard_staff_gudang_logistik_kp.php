...
class Dashboard_staff_gudang_logistik_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['left_menu'] = "dashboard_staff_gudang_logistik_kp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_staff_gudang_logistik_kp/content_dashboard_staff_gudang_logistik_kp');
