...
class Dashboard_manajer_hsse_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['left_menu'] = "dashboard_manajer_hsse_kp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_manajer_hsse_kp/content_dashboard_manajer_hsse_kp');
