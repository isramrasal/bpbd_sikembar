...
class RASD extends CI_Controller
{
	...
	public function logout()
	{
		...
		$KETERANGAN = "Paksa Logout Ketika Akses List RASD";
		$WAKTU = date('Y-m-d H:i:s');
		$this->RASD_model->user_log_rasd($user->ID_PEGAWAI, $KETERANGAN, $WAKTU);
	...
	public function index()
	{
		...
		// 	$this->load->view('wasa/user_admin/content_RASD');
		...
		// 	$this->load->view('wasa/user_staff_procurement_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_kasie_procurement_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_manajer_procurement_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_staff_procurement_sp/content_RASD');
		...
		// 	$this->load->view('wasa/user_supervisi_procurement_sp/content_RASD');
		...
		// 	$this->load->view('wasa/user_staff_umum_logistik_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_kasie_logistik_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_manajer_logistik_kp/content_RASD');
		...
		// 	$this->load->view('wasa/user_staff_umum_logistik_sp/content_RASD');
		...
		// 	$this->load->view('wasa/user_staff_gudang_logistik_sp/content_RASD');
		...
		// 	$this->load->view('wasa/user_supervisi_logistik_sp/content_RASD');
	...
	{
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
			$data = $this->RASD_model->RASD_list();
			echo json_encode($data);

			$KETERANGAN = "Melihat Data RASD: " . json_encode($data);
			...
			$data = $this->RASD_model->RASD_list_by_id_proyek($ID_PROYEK);
			echo json_encode($data);
	...
	function get_list_rasd_by_id_proyek()
    {
        if ($this->ion_auth->logged_in()) {
            $ID_PROYEK = $this->input->post('ID_PROYEK');
            $data = $this->RASD_model->get_list_rasd_by_id_proyek($ID_PROYEK);
            echo json_encode($data);
	...
	// 		$data = $this->RASD_model->get_data_by_id_RASD($id);
	// 		echo json_encode($data);
	...
	// 		$ID_RASD = $this->input->post('kode');
	// 		$data_hapus = $this->RASD_model->get_data_by_id_RASD($ID_RASD);

	// 		$data = $this->RASD_model->hapus_data_by_id_RASD($ID_RASD);
	// 		echo json_encode($data);

	// 		$KETERANGAN = "Hapus Data RASD: " . json_encode($data_hapus);
	// 		$this->user_log($KETERANGAN);
	// 	} else if ($this->ion_auth->logged_in() && $this->ion_auth->in_group(7)) {
