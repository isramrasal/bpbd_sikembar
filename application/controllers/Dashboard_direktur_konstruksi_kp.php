...
class Dashboard_direktur_konstruksi_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Direktur Konstruksi KP';
		$this->data['left_menu'] = "dashboard_direktur_konstruksi_kp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_direktur_konstruksi_kp/content_dashboard_direktur_konstruksi');
