...
class Dashboard_chief_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Chief SP';
		$this->data['left_menu'] = "dashboard_chief_sp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_chief_sp/content_dashboard_chief_sp');
