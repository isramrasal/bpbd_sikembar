...
class Dashboard_pm_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard PM SP';
		$this->data['left_menu'] = "dashboard_pm_sp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_pm_sp/content_dashboard_pm_sp');
