...
class Dashboard_pegawai_bpbd extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SiKembar | Dashboard Pegawai BPBD';
		$this->data['left_menu'] = "dashboard_pegawai_bpbd_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()&&$this->ion_auth->in_group(2)) {
			...
			$this->load->view('wasa/user_pegawai_bpbd/content_dashboard_pegawai_bpbd');
