...
class SPPB_form extends CI_Controller
{
	...
	public function index() //BEDA KP DAN SP
	{
		...
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) { //ADMIN
			...
			if ($PROGRESS_SPPB == "Diproses oleh Staff Procurement KP") {
				$HASH_MD5_SPPB = $this->uri->segment(3);
				$hasil = $this->SPPB_model->get_id_sppb_by_HASH_MD5_SPPB($HASH_MD5_SPPB);
				$ID_SPPB = $hasil['ID_SPPB'];
				$this->data['ID_PROYEK'] = $hasil['ID_PROYEK'];
			...
			if ($PROGRESS_SPPB == "Diproses oleh Staff Procurement SP") {
				$HASH_MD5_SPPB = $this->uri->segment(3);
				$hasil = $this->SPPB_model->get_id_sppb_by_HASH_MD5_SPPB($HASH_MD5_SPPB);
				$ID_SPPB = $hasil['ID_SPPB'];
				$this->data['ID_PROYEK'] = $hasil['ID_PROYEK'];
				...
				$this->load->view('wasa/user_staff_procurement_sp/content_sppb_form_proses');
			...
			if ($PROGRESS_SPPB == "Diproses oleh Supervisi Procurement SP") {
				$HASH_MD5_SPPB = $this->uri->segment(3);
				$hasil = $this->SPPB_model->get_id_sppb_by_HASH_MD5_SPPB($HASH_MD5_SPPB);
				$ID_SPPB = $hasil['ID_SPPB'];
				$this->data['ID_PROYEK'] = $hasil['ID_PROYEK'];
				...
				$this->load->view('wasa/user_supervisi_procurement_sp/content_sppb_form_proses');
