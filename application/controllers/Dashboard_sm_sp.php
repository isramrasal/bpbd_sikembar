...
class Dashboard_sm_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard SM SP';
		$this->data['left_menu'] = "dashboard_sm_sp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_sm_sp/content_dashboard_sm_sp');
