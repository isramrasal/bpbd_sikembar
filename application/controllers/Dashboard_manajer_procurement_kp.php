...
class Dashboard_manajer_procurement_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Manajer Procurement KP';
		$this->data['left_menu'] = "dashboard_manajer_procurement_kp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_manajer_procurement_kp/content_dashboard_manajer_procurement_kp');
