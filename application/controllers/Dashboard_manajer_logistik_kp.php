...
class Dashboard_manajer_logistik_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Manajer logistik';
		$this->data['left_menu'] = "dashboard_manajer_logistik_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_manajer_logistik_kp/content_dashboard_manajer_logistik_kp');
