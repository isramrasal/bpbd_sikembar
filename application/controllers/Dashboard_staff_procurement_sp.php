...
class Dashboard_staff_procurement_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Staff Procurement SP';
		$this->data['left_menu'] = "dashboard_staff_procurement_sp_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_staff_procurement_sp/content_dashboard_staff_procurement_sp');
