...
class Dashboard_staff_umum_logistik_sp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Staff Umum logistik';
		$this->data['left_menu'] = "dashboard_staff_umum_logistik_aktif";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in() && $this->ion_auth->in_group(13)) {
			...
			$this->load->view('wasa/user_staff_umum_logistik_sp/content_dashboard_staff_umum_logistik_sp');
