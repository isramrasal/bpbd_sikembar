...
class Dashboard_staff_umum_logistik_kp extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['title'] = 'SIPESUT WME | Dashboard Staff Umum Logistik KP';
		$this->data['left_menu'] = "dashboard_staff_umum_logistik_kp";
	}
	...
	public function index()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			$this->load->view('wasa/user_staff_umum_logistik_kp/content_dashboard_staff_logistic_kp');
