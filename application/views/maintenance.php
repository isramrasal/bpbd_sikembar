...
<head>
    ...
    <title>Wasa Mitra Engineering Employment System | Maintenance</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <h1>404</h1>
        <h3 class="font-bold">Aplikasi dalam masa pemeliharaan</h3>

        <div class="error-desc">
           Maaf, tetapi halaman yang Anda cari tidak ditemukan. Coba periksa URL untuk kesalahan, lalu tekan tombol segarkan pada browser Anda atau coba temukan yang lain di aplikasi kami.
        </div>
    </div>
