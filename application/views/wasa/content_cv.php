            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
					...
					<tr>
						...
						<td><?php echo $pg['NAMA_DEPARTEMEN']; ?></td>
						<td>
							<a href="<?php echo base_url(); ?>index.php/cv/lihat_cv/<?php echo $pg['ID_PEGAWAI']; ?>" class="btn btn-info btn-xs"><i class="fa fa-binoculars"></i> Lihat CV </a>
						</td>
					</tr>
					<?php
					}
        ...
        $(document).ready(function(){
			...
			$('#mydata').dataTable(
			{
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'CV Pegawai'},
                    {extend: 'pdf', title: 'CV Pegawai'},
