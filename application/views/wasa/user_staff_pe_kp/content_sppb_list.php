            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        if (data[i].PROGRESS_SPPB == "Dalam Proses Staff Procurement Kantor Pusat") {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + html_progress + '</td>' +
                            '<td>' +
                            '<a href="<?php echo base_url() ?>SPPB_form/view/' + data[i].HASH_MD5_SPPB + '" class="btn btn-primary btn-xs btn-outline" target="_blank"><i class="fa fa-eye"></i> ' + data[i].NO_URUT_SPPB + ' </a>' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
