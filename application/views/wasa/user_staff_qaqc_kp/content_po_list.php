...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="alert alert-info alert-dismissable">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
        Sistem menampilkan SPPB yang diajukan dari seluruh proyek, dan PO yang telah dibuat.
    </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data_1.length; i++) {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('PO/get_list_po_by_id_sppb') ?>",
                            type: "POST",
                            dataType: "JSON",
                            async: false,
                            data: {
                            ...
                            success: function(data) {
                                ...
                                html += '<a href="javascript:;" class="btn btn-info btn-xs item_buat_po_baru" data="' + data_1[i].HASH_MD5_SPPB + '"><i class="fa fa-plus"></i> Buat PO </a>' + ' ' +
                                    '</td>' +
                                    '</tr>';
                            }
                        });
        ...
        $('#show_data').on('click', '.item_buat_po_baru', function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('index.php/PO/get_data_proyek_by_hash_md5_sppb') ?>",
                dataType: "JSON",
                data: {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                $.each(data, function() {
                                    ...
                                    $('[name="NO_URUT_PO"]').val(`${NO_URUT}/PO/WME/${INISIAL}/2021`);
                                    $('[name="FILE_NAME_TEMP"]').val(`${NO_URUT}_PO_WME_${INISIAL}_2021`);
