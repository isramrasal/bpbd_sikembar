                ...
                <div class="ibox-content">
                    ...
                    <div class="form-horizontal">
                        ...
                        ?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">ID KHP:</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $ID_KHP; ?>" disabled></div>
                                </div>
        ...
        <div class="modal-dialog" style="width: 80vw;">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Silakan tambah pengajuan harga barang/jasa RFQ</small>
                </div>
                ...
                <div class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <input name="ID_KHP_FORM2" id="ID_KHP_FORM2" class="form-control" type="text" readonly>
                        <input name="ID_KHP2" id="ID_KHP2" class="form-control" type="text" readonly>
