                            ...
                            <form method="get" class="form-horizontal">
                                ...
                                ?>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Tanggal Pembuatan :</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $SPPB->TANGGAL_DOKUMEN_SPPB; ?>" disabled>
                                            </div>
                                        </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_STAFF_GUDANG_LOG6" id="CTT_STAFF_GUDANG_LOG6" required></textarea>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        var jumlah_barang = data[i].JUMLAH_MINTA;
                        var jumlah_rasd = data[i].JUMLAH_RASD;
                        var kode_barang = data[i].KODE_BARANG;
                        var no_urut_fpb = data[i].NO_URUT_FPB;
                        ...
                        if (no_urut_fpb != null) {
                            no_urut_fpb_cetak = '<a href="<?php echo base_url() ?>FPB_form/view/' + data[i].HASH_MD5_FPB + '" class="btn btn-primary btn-xs btn-outline block" target="_blank"><i class="fa fa-eye"></i> ' + no_urut_fpb + ' </a>';

                            tombol_edit = '';
                        }
                        if (no_urut_fpb == null) {
                            no_urut_fpb_cetak = '<span class="label label-info block"><i class="fa fa-warning"></i> Data Di Luar FPB </span> <br>' + data[i].BIDANG_PEMAKAI;

                            tombol_edit = '<a href="javascript:;" class="btn btn-warning btn-xs item_edit block" data="' + data[i].ID_SPPB_FORM + '"><i class="fa fa-pencil"></i> Edit </a>';
                        }
                        ...
                        var form_data = {
                            ID_BARANG_MASTER: data[i].ID_BARANG_MASTER,
                            ID_RASD: data[i].ID_RASD_MASTER
                        };
                        ...
                        var form_data_2 = {
                            ID_BARANG_MASTER: data[i].ID_BARANG_MASTER,
                            ID_PROYEK: data[i].ID_PROYEK,
                        };

                        if (data[i].PERALATAN_PERLENGKAPAN == "CONSUMABLE" || data[i].PERALATAN_PERLENGKAPAN == "Consumption" || data[i].PERALATAN_PERLENGKAPAN == "MATERIAL") {
                            $.ajax({
                        ...
                        if (data[i].JUMLAH_MINTA - jumlah_quantity <= 0) {
                            jumlah_qty_spp = 0;
                        } else {
                            jumlah_qty_spp = data[i].JUMLAH_MINTA - jumlah_quantity;
                        }
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + data[i].TANGGAL_MULAI_PAKAI_HARI + '</td>' +
                            '<td>' + data[i].TANGGAL_SELESAI_PAKAI_HARI + '</td>' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_STAFF_GUDANG_LOG_KP);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_STAFF_GUDANG_LOG6"]').val(data.CTT_STAFF_GUDANG_LOG_KP);
        ...
        $('#btn_simpan_data_di_luar_barang_master').click(function() {
            var form_data = {
                ...
                JUMLAH_MINTA: $('#JUMLAH_MINTA_4').val(),
            };
            $.ajax({
        ...
        $('#btn_update_catatan_sppb').on('click', function() {
            ...
            let CTT_STAFF_GUDANG_LOG_KP = $('#CTT_STAFF_GUDANG_LOG6').val();
            $.ajax({
