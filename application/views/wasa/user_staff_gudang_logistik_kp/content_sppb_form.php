...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_SPPB == "Dalam Proses Staff Gudang Logistik KP") { ?>
                <a href="<?php echo base_url('index.php/SPPB_form/index/') ?><?php echo $HASH_MD5_SPPB; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Proses SPPB</a>
