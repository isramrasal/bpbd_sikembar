...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="alert alert-info alert-dismissable">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
        Sistem menampilkan PO yang diajukan dari seluruh proyek, dan RPB yang telah dibuat.
    </div>
                            ...
                            success: function(data) {
                                ...
                                if (data_2 == 'TIDAK ADA DATA') {
                                    ...
                                    for (j = 0; j < data_2.length; j++) {
                                        ...
                                        html += '<a href="#" class="btn btn-link btn-xs block text-decoration-none"> ' + html_progress + "</br>" ;
                                    }
                                ...
                                html += '<a href="javascript:;" class="btn btn-info btn-xs item_buat_po_baru" data="' + data_1[i].HASH_MD5_PO + '"><i class="fa fa-plus"></i> Buat Rencana Pengiriman Barang </a>' + ' ' +
                                    '</td>' +
                                    '</tr>';
                            }
                        });
