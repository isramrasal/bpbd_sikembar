            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_STAFF_PROC_PROYEK6" id="CTT_STAFF_PROC_PROYEK6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].CORET == '1') {
                            html += '<tr>' +
                                ...
                                '<td class="danger"> <strike>' + data[i].HARGA_TOTAL_FIX + '</td> </strike>' +
        ...
        $('#btn_update_catatan_spp').on('click', function() {
            ...
            let CTT_STAFF_PROC_PROYEK = $('#CTT_STAFF_PROC_PROYEK6').val();
            $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_STAFF_PROC_PROYEK6"]').val(data.CTT_STAFF_PROC_PROYEK);
