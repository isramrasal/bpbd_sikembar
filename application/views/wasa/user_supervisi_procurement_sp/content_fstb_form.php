...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <a href="<?php echo base_url('index.php/FSTB/') ?>" class="btn btn-primary"> Kembali Ke Halaman List FISTB</a>
            <?php if ($PROGRESS_FSTB == "Diproses oleh Supervisi Procurement SP") { ?>
