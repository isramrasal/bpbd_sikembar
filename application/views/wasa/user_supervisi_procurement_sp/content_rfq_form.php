...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_RFQ == "Dalam Proses Pembuatan Supervisi Procurement SP") { ?>
            ...
            <?php
            } else if ($PROGRESS_RFQ == "Dalam Proses Supervisi Procurement SP") {
            ?>
                <a href="<?php echo base_url('index.php/RFQ_form/index/') ?><?php echo $HASH_MD5_RFQ; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Ubah RFQ</a>
                <a href="javascript:;" id="item_edit_kirim_rfq" name="item_edit_kirim_rfq" class="btn btn-success" data="<?php echo $HASH_MD5_RFQ; ?>"><span class="fa fa-send"></span> Ajukan RFQ Untuk Proses Selanjutnya </a>
            <?php
            ...
            <a href="<?php echo base_url('index.php/RFQ_form/pengajuan_vendor/') ?><?php echo $HASH_MD5_RFQ; ?>" class="btn btn-danger"><span class="fa fa-book"></span> Lihat Harga Pengajuan Vendor</a>
        </div>
    </div>
    <!-- End Identitas Form RFQ -->

    <!-- Upload Document Form RFQ -->
    <?php if ($FILE == "ADA") { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Attachment Dokumen RFQ - Dari Vendor</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
    ...
    <?php } else { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Attachment Dokumen RFQ</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
    ...
    <div class="modal-dialog" style="width: 30vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Ajukan RFQ</h4>
                <small class="font-bold">Selesaikan proses dan ajukan Form RFQ ini untuk proses selanjutnya</small>
            </div>
            ...
            <div class="form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="btn_update_kirim_rfq" disabled><i class="fa fa-send"></i> Ajukan</button>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
                    ...
                    $("#btn_upload").click(function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data != '') {
                                    alert("Anda belum mengunggah file dokumen");
                                } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.ID_VENDOR == null || data.ID_TERM_OF_PAYMENT == null || data.ID_PROYEK_LOKASI_PENYERAHAN == null) {
                        ...
                        alert("Anda belum menentukan Vendor atau Term of Payment atau Lokasi Penyerahan"); //called second
