...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_SPP == "Dalam Proses Supervisi Procurement SP") { ?>
                ...
                <a href="javascript:;" id="item_edit_tampilkan_kontrol_angagran" name="item_edit_tampilkan_kontrol_angagran" class="btn btn-primary" data="<?php echo $ID_SPP; ?>"><span class="fa fa-money "></span> Sembunyikan atau Tampilkan Kontrol Anggaran</a>
            ...
            <?php
            } else if ($PROGRESS_SPP == "Diproses oleh Supervisi Procurement SP") {
            ?>
                <a href="<?php echo base_url('index.php/SPP_form/index/') ?><?php echo $HASH_MD5_SPP; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Ubah SPP</a>
                <a href="javascript:;" id="item_edit_tampilkan_kontrol_angagran" name="item_edit_tampilkan_kontrol_angagran" class="btn btn-primary" data="<?php echo $ID_SPP; ?>"><span class="fa fa-money "></span> Sembunyikan atau Tampilkan Kontrol Anggaran</a>
                <a href="javascript:;" id="item_edit_kirim_spp" name="item_edit_kirim_spp" class="btn btn-success" data="<?php echo $ID_SPP; ?>"><span class="fa fa-send"></span> Ajukan SPP Untuk Proses Selanjutnya </a><br>
...
<script>
    ...
    $(document).ready(function() {
        ...
        item_edit_tampilkan_kontrol_angagran.onclick = function() {
            var ID_SPP = $(this).attr('data');
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('SPP_form/data_spp_form_kirim_SPP') ?>",
