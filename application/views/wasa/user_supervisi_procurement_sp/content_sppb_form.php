<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_SPPB == "Diproses oleh Supervisi Procurement SP") { ?>
            ...
            <?php
                ...
                <a href="#" id="item_edit_kirim_sppb" name="item_edit_kirim_sppb" class="btn btn-primary" data="" style="display:none">&nbsp;</a>
            <?php } ?>
