            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_D_PSDS6" id="CTT_D_PSDS6"  required></textarea>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + html_progress + '</td>' +
                            '<td>' + data[i].JUMLAH_SETUJU_M_LOG + '</td>' +
                            // '<td>' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_D_PSDS6"]').val(data.CTT_D_PSDS);
        ...
        let CTT_D_PSDS = $('#CTT_D_PSDS6').val();
        $.ajax({
