        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function() {
                    ...
                    $('[name="NO_URUT_FSTB"]').val(`${NO_URUT}/FSTB/WME/${INISIAL}/2021`);
                    $('[name="NO_URUT_FIB"]').val(`${NO_URUT}/FIB/WME/${INISIAL}/2021`);
                    $('[name="FILE_NAME_TEMP"]').val(`${NO_URUT}_FSTB_WME_${INISIAL}_2021`);
                    $('[name="FILE_NAME_TEMP_FIB"]').val(`${NO_URUT}_FIB_WME_${INISIAL}_2021`);
                });
