    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="nip" id="nip" value="<?php echo set_value('nip'); ?>"
                    placeholder="NIP" autofocus>
            </div>
            <div class="form-group">
                <input type="email" class="form-control" name="email" id="email"
                    value="<?php echo set_value('email'); ?>" placeholder="Email" autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="form-control" name="password_confirm" id="password_confirm"
                    value="<?php echo set_value('password_confirm'); ?>" placeholder="Konfirmasi Password">
            </div>
            <div class="form-group">
                <div class="checkbox i-checks"><label> <input type="checkbox" id="terms"><i></i> Saya setuju tentang
                        syarat dan ketentuan </label></div>
            </div>
            <button id="daftar" type="submit" class="btn btn-primary block full-width m-b" disabled>Register</button>


            <a class="btn btn-sm btn-white btn-block" href="<?php echo base_url(); ?>index.php/auth/login">Kembali ke
                halaman Login</a>
            <?php echo form_close(); ?>
