...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_RFQ == "Dalam Proses Staff Procurement KP") { ?>
            ...
            ?>
                ...
                <a href="<?php echo base_url('index.php/RFQ/') ?>" class="btn btn-success" disabled><span class="fa fa-send"></span> Ajukan RFQ Untuk Proses Selanjutnya </a>
            <?php
            }
            ?>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Download/Upload Dokumen RFQ Cap Basah</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
                                ...
                                <?php foreach ($dokumen as $barang_master_file) { ?>
                                    ...
                                    <div class="file-box">
										...
										<i class='fa fa-file'></i>
                                                ...
                                                <div class="file-name">
                                                    <a href="<?php echo base_url(); ?>assets/upload_rfq_form_file/<?php echo $barang_master_file->DOK_FILE; ?>">Download file</a>
                                                    <br />
                                                ...
                                                <input type="button" class="btn btn-block btn-outline btn-danger" onclick="location.href='<?php echo base_url(); ?>index.php/rfq_form/hapus_file/<?php echo $barang_master_file->DOK_FILE; ?>';" value="Hapus" />
            ...
            <a href="javascript:;" id="item_edit_upload_gambar" name="item_edit_upload_gambar" class="btn btn-primary" data="<?php echo $HASH_MD5_RFQ; ?>"><i class="fa fa-upload" aria-hidden="true"></i> Upload Foto Tanda Tangan Basah</a>
        </div>
    </div>
</div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <input name="HASH_MD5_RFQ7" id="HASH_MD5_RFQ7" class="form-control" type="hidden" placeholder="HASH_MD5_RFQ" readonly>


                    <div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox" id="saya_setuju"><i></i> Saya telah selesai melalukan proses form RFQ ini dan menyetujui untuk diproses lebih lanjut </label></div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let PROGRESS_RFQ = "<?php echo $PROGRESS_RFQ ?>";
        ...
        if (PROGRESS_RFQ != "Dalam Proses Staff Procurement KP") {
        ...
        item_edit_kirim_email_rfq.onclick = function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.ID_VENDOR == null || data.TOP == null || data.LOKASI_PENYERAHAN == null || data.PROGRESS_RFQ == "Dalam Proses Staff Procurement KP" || data.PROGRESS_RFQ == "Dalam Proses Kasie Procurement KP") {
                        console.log(data);
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "<?php echo base_url('RFQ_form/get_po_file') ?>",
        //         dataType: "JSON",
        //         data: {
        //             id: id
        //         },
