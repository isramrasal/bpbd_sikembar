...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>fstb_<?php echo $HASH_MD5_FSTB; ?>.pdf</h5>
        ...
        <div class="ibox-content">
            ...
            <?php if ($STATUS_FSTB == "Draft") { ?>
                ...
                <a href="javascript:;" id="item_edit_kirim_fstb" name="item_edit_kirim_fstb" class="btn btn-primary" data="<?php echo $ID_FSTB; ?>"><span class="fa fa-send"></span> Ajukan FSTB</a>
            <?php
            }
            ?>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>fib_<?php echo $HASH_MD5_FSTB; ?>.pdf</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox" id="saya_setuju"><i></i> Saya telah selesai melakukan pengisian form FSTB ini dan menyetujui untuk diproses lebih lanjut </label></div>
                    </div>
