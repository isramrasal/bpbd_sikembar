 ...
 <div class="wrapper wrapper-content animated fadeInRight">
     ...
     <dl class="m-t-md">
         ...
         <dt>Dimensi :</dt>
         <dd><?php echo $master->DIMENSI_PANJANG . ' cm x ' . $master->DIMENSI_LEBAR . ' cm x ' . $master->DIMENSI_TINGGI . ' cm' ?>
         </dd>
     </dl>
     ...
     <hr>
     <button class="btn btn-primary btn-sm" style="font-weight: bold;"><i class="fa fa-download"></i> Download Buku
         Panduan</button>
 </div>
 <?php
					}
     ...
     <div class="col-lg-12">
         <div class="ibox float-e-margins">
             ...
             <div class="ibox-content">
                 ...
                 <a href="<?php echo base_url(); ?>index.php/barang_entitas/view_tambah" class="btn btn-success"><span
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    html += '<tr>' +
                        ...
                        data[i].ID_BARANG_ENTITAS + '"><i class="fa fa-pencil"></i> Edit </a>' +
                        ' ' +
                        '<a href="javascript:;" class="btn btn-danger btn-xs item_hapus" data="' +
                        data[i].ID_BARANG_ENTITAS + '"><i class="fa fa-trash"></i> Hapus</a>' +
                        '</td>' +
                        '</tr>';
                }
                $('#show_data').html(html);
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(
                    ...
                    $('[name="TANGGAL_SELESAI_SEWA2"]').val(data
                        .TANGGAL_SELESAI_SEWA);
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(ID_BARANG_ENTITAS, KODE_BARANG_ENTITAS) {
                    ...
                    $('[name="kode"]').val(id);
                    $('#KODE_BARANG_ENTITAS3').html('Kode Barang Entitas: ' + data
                        .KODE_BARANG_ENTITAS);
                });
            }
        });
