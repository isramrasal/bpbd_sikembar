...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<?php foreach ($query_vendor_HASH_MD5_VENDOR_result as $data_vendor) { ?>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<dl class="dl-horizontal">
						...
						?>
							<dt>Status:</dt>
							<dd><span class="label label-primary">AKTIF</span></dd>
						<?php
						}
						?>
						...
						?>
							<dt>Status:</dt>
							<dd><span class="label label-danger">TIDAK AKTIF</span></dd>
						<?php
						}
						?>
			...
			<div class="row">
				<div class="col-lg-5">
					<dl class="dl-horizontal">
						...
						<dt>Nama Vendor:</dt>
						<dd><?php echo $data_vendor->NAMA_VENDOR; ?></dd>
						<dt>Alamat Vendor:</dt>
						<dd> <?php echo $data_vendor->ALAMAT_VENDOR; ?></dd>
						<dt>Nomor Telepon Vendor:</dt>
						<dd> <?php echo $data_vendor->NO_TELP_VENDOR; ?></dd>
						<dt>Email Vendor:</dt>
						<dd> <?php echo $data_vendor->EMAIL_VENDOR; ?></dd>
					</dl>
				</div>
				<div class="col-lg-5">
					<dl class="dl-horizontal">

						<dt>Nama PIC Vendor:</dt>
						<dd><?php echo $data_vendor->NAMA_PIC_VENDOR; ?></dd>
						<dt>Nomor HP PIC Vendor:</dt>
						<dd> <?php echo $data_vendor->NO_HP_PIC_VENDOR; ?></dd>
						<dt>Email PIC Vendor:</dt>
						<dd> <?php echo $data_vendor->EMAIL_PIC_VENDOR; ?></dd>
							...
							<div class="file-box">
								<div class="file">
									<a href="#">
										...
										<div class="file-name">
											<a href="<?php echo base_url(); ?>assets/upload_vendor_file/<?php echo $vendor_file->DOK_FILE; ?>">Download file</a>
											<br />
