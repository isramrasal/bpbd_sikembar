                            ...
                            <form method="get" class="form-horizontal">
                                ...
                                if (isset($Penyaluran)) {
                                    foreach ($Penyaluran->result() as $Penyaluran):
                                        ?>
                                        <div class="form-group"><label class="col-sm-2 control-label">No. Surat Penyaluran</label>
                                            <div class="col-sm-10">
                                                    <input name="NO_SURAT_GANTI" id="NO_SURAT_GANTI" type="text" class="form-control"
                                                    value="<?php echo $Penyaluran->Nomor_Surat; ?>">
                                                    <input name="NO_SURAT_GANTI_ASLI" id="NO_SURAT_GANTI_ASLI" type="hidden" class="form-control" value="<?php echo $Penyaluran->Nomor_Surat; ?>">
                                            </div>
                                        </div>

                                        <div class="form-group" id="data_TANGGAL_DOKUMEN_PENYALURAN"><label class="col-sm-2 control-label">Tanggal Dokumen Penyaluran</label>
                                            <div class="col-sm-10">
                                                <?php
                                                if (empty($Penyaluran->Tanggal_Surat)) {
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_DOKUMEN_PENYALURAN" name="TANGGAL_DOKUMEN_PENYALURAN" type="text" class="form-control" placeholder="dd/mm/yyyy">
                                                    </div>
                                                <?php
                                                } else {
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_DOKUMEN_PENYALURAN" name="TANGGAL_DOKUMEN_PENYALURAN" type="text" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $Penyaluran->Tanggal_Surat; ?>">
                                                    </div>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Jabatan Penerima</label>
                                            <div class="col-sm-10"><input name="JABATAN_PENERIMA" id="JABATAN_PENERIMA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Jabatan_Penerima; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Instansi</label>
                                            <div class="col-sm-10"><input name="INSTANSI_PENERIMA" id="INSTANSI_PENERIMA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Instansi_Penerima; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Kampung Bencana</label>
                                            <div class="col-sm-10"><input name="KAMPUNG_BENCANA" id="KAMPUNG_BENCANA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Kampung_Bencana; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Desa/Kelurahan</label>
                                            <div class="col-sm-10"><input name="DESA_KELURAHAN_BENCANA" id="DESA_KELURAHAN_BENCANA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Desa_Kelurahan_Bencana; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Kecamatan</label>
                                            <div class="col-sm-10"><input name="KECAMATAN_BENCANA" id="KECAMATAN_BENCANA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Kecamatan_Bencana; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Kabupaten/Kota</label>
                                            <div class="col-sm-10"><input name="KABUPATEN_KOTA_BENCANA" id="KABUPATEN_KOTA_BENCANA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Kabupaten_Kota_Bencana; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Kode Pos</label>
                                            <div class="col-sm-10"><input name="KODE_POS_BENCANA" id="KODE_POS_BENCANA" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Kode_Pos_Bencana; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Nama Pegawai BPBD</label>
                                            <div class="col-sm-10"><input name="NAMA_PEJABAT_BPBD" id="NAMA_PEJABAT_BPBD" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Nama_Pejabat_BPBD; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">NIK Pegawai BPBD</label>
                                            <div class="col-sm-10"><input name="NIK_PEJABAT_BPBD" id="NIK_PEJABAT_BPBD" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->NIK_Pejabat_BPBD; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">NIP Pegawai BPBD</label>
                                            <div class="col-sm-10"><input name="NIP_PEJABAT_BPBD" id="NIP_PEJABAT_BPBD" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->NIP_Pejabat_BPBD; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Jabatan Pegawai BPBD</label>
                                            <div class="col-sm-10"><input name="JABATAN_PEJABAT_BPBD" id="JABATAN_PEJABAT_BPBD" type="text"
                                                    class="form-control" value="<?php echo $Penyaluran->Jabatan_Pejabat_BPBD; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group" id="data_TANGGAL_KEJADIAN_BENCANA"><label class="col-sm-2 control-label">Tanggal Kejadian Bencana</label>
                                            <div class="col-sm-10">
                                                ...
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_KEJADIAN_BENCANA" name="TANGGAL_KEJADIAN_BENCANA" type="text" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $Penyaluran->TANGGAL_KEJADIAN_BENCANA; ?>">
                                                    </div>
                                                <?php
                                                }
                                                ?>
                    ...
                    <div class="form-group">
                        <div class="sm-10">
                            ...
                            <a href="javascript:;" id="item_edit_kirim_pengajuan" name="item_edit_kirim_pengajuan"
                                class="btn btn-success" data="<?php echo $ID_FORM_PENYALURAN_BARANG_BENCANA; ?>"><span class="fa fa-send"></span>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#mydata').dataTable({
            ...
            buttons: [{
                extend: 'excel',
                title: 'SPPB export EXCEL <?php echo $Nomor_Surat ?>',
                exportOptions: {
            ...
            },
            {
                ...
                title: 'SPPB export <?php echo $Nomor_Surat ?>',
                pageSize: 'A4',
