        ...
        if (ID_JENIS_BENCANA_LIST == "Semua") {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html_head =
                        '<tr><th>No. Pengajuan</th><th>Jenis Bencana</th><th>Nama Pemohon</th><th>NIK Pemohon</th><th>Instansi</th><th>Kecamatan</th><th>Desa</th><th>Tanggal Bencana</th><th>Tanggal Pengajuan</th><th>Aksi</th></tr>';
                    $('#show_data_head').html(html_head);
                    $('#show_data').html(html);
