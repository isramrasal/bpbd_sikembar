            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].PROGRESS_FPB == "Dalam Proses Staff Logistik") {
                            ...
                            if (data[i].DUE_DATE_STAFF_LOGISTIK != null) {
                                var tandaminus = data[i].SELISIH_WAKTU_DUE_DATE_STAFF_LOGISTIK[0];
                                if (tandaminus == '-') {
                                    due_date = '</br> <h1 style="font-size:10px"> Batas akhir proses: </br> <b>' + data[i].DUE_DATE_STAFF_LOGISTIK + '</b></h1>';
                                } else {
                                    due_date = '';
                                }
                            } else {
