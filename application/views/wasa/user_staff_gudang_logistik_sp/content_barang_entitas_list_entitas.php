		...
		<div class="modal-content animated bounceInRight">
			...
			<div class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="control-label col-xs-3">Nomor Urut Barang</label>
						<div class="col-xs-9">
							<div>
								<input name="NO_URUT_BARANG" id="NO_URUT_BARANG" class="form-control" type="number" placeholder="0001 dst">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
							<div>
								<input name="KODE_BARANG_ENTITAS" id="KODE_BARANG_ENTITAS" class="form-control" type="text" disabled>
							</div>
						</div>
					</div>
			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function() {
						...
						$('[name="NO_URUT_BARANG"]').val(NO_URUT);
						$('[name="KODE_BARANG_ENTITAS"]').val(KODE_BARANG_ENTITAS);
					});
