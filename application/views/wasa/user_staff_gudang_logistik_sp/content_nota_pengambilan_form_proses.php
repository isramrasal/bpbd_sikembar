<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Form Nota Pengambilan Barang</h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url('index.php') ?>">Home</a>
            </li>
            <li>
                <a href="<?php echo base_url('index.php/SPPB/') ?>">Nota Pengambilan Barang</a>
            </li>
            <li class="active">
                <strong>
                    <a>Nota Pengambilan Barang</a>
                </strong>
            </li>
        </ol>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Formulir Nota Pengambilan Barang</h5>
        ...
        <div class="ibox-content">
            ...
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#tab-2">Catatan Nota Pengambilan Barang</a></li>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            ?>
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Daftar Item Barang/Jasa dari FPB</h4>
                    <b class="font-bold">Maaf semua item barang/jasa dari FPB sudah ada di Form SPPB ini atau seluruh item sudah diproses di SPPB yang lain</b>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close"></i> Batal</button>
                </div>
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data_1.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            // '<td>' + data[i].JUMLAH_SETUJU_STAFF_LOG + '</td>' +
