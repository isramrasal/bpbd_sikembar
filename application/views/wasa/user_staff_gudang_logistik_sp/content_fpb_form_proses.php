...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Formulir Pemrosesan Form Permintaan Barang</h5>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="alert alert-danger alert-dismissable block">
                            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                            <div class="blink">
                                <center>Pastikan Anda memastikan quantity yang tersedia dengan benar. Pengubahan jumlah stock dilakukan melalui menu Gudang Barang</center>
                            </div>
                        </div>
                    </div>
                    </br>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <input name="ID_FPB8" id="ID_FPB8" class="form-control" type="hidden" placeholder="ID FPB" readonly>
                            <button class="btn btn_outline-primary" id="btn_update_qty_fpb"><i class="fa fa-refresh"></i> Update Form</button></br>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="REMARKS_STAFF_GUDANG_LOGISTIK5" id="REMARKS_STAFF_GUDANG_LOGISTIK5" placeholder="Contoh: " required></textarea>
                        </div>
                    </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_STAFF_GUDANG_LOGISTIK6" id="CTT_STAFF_GUDANG_LOGISTIK6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function tampil_data_fpb_form() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var html = '';
                    var i, j, k = 0;
                    var jumlah_quantity, jumlah_qty_sppb = 0;
                    ...
                    for (i = 0; i < data_1.length; i++) {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('FPB_form/data_qty_entitas') ?>",
                            type: "POST",
                            dataType: "JSON",
                            async: false,
                            data: form_data,
                        ...
                        let jumlah_rasd = data_1[i].JUMLAH_RASD;
                        let kode_barang = data_1[i].KODE_BARANG;

                        ///Rumus hitung barang yang lanjut ke SPPB
                        if (data_1[i].JUMLAH_MINTA - jumlah_quantity <= 0) {
                            jumlah_qty_sppb = 0;
                        } else {
                            jumlah_qty_sppb = data_1[i].JUMLAH_MINTA - jumlah_quantity;
                        }
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + jumlah_qty_sppb + '</td>' +
                            '<td>' + data_1[i].TANGGAL_MULAI_PAKAI + '</td>' +
                            '<td>' + data_1[i].TANGGAL_SELESAI_PAKAI + '</td>' +
                            '<td>' +
                            '<a href="javascript:;" class="btn btn-success btn-xs item_edit_remarks block" data="' + data_1[i].ID_FPB_FORM + '"><i class="fa fa-comment  "></i> Remarks </a>' + ' ' + data_1[i].REMARKS_CHIEF + ' ' + data_1[i].REMARKS_STAFF_GUDANG_LOGISTIK + ' ' + data_1[i].REMARKS_SM + ' ' + data_1[i].REMARKS_STAFF_UMUM_LOGISTIK +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
        ...
        //GET UDPATE untuk berikan remarks
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="REMARKS_STAFF_GUDANG_LOGISTIK5"]').val(data.REMARKS_STAFF_GUDANG_LOGISTIK5);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_STAFF_GUDANG_LOGISTIK6"]').val(data.CTT_STAFF_GUDANG_LOGISTIK);
        ...
        $('#btn_update_remarks_barang').on('click', function() {
            ...
            let REMARKS_STAFF_GUDANG_LOGISTIK = $('#REMARKS_STAFF_GUDANG_LOGISTIK5').val();
            $.ajax({
        ...
        $('#btn_update_catatan_fpb').on('click', function() {
            ...
            let CTT_STAFF_GUDANG_LOGISTIK = $('#CTT_STAFF_GUDANG_LOGISTIK6').val();
            $.ajax({
                ...
                data: {
                    ID_FPB: ID_FPB,
                    CTT_STAFF_GUDANG_LOGISTIK: CTT_STAFF_GUDANG_LOGISTIK
                },
                success: function(data) {
                    if (data == true) {
                                ...
                                for (i = 0; i < data_1.length; i++) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            if (data_1[i].JUMLAH_MINTA - jumlah_quantity < 0) {
                                                jumlah_qty_sppb = data_1[i].JUMLAH_MINTA;
                                            } else {
                                                jumlah_qty_sppb = data_1[i].JUMLAH_MINTA - jumlah_quantity;
                                            }

                                            var form_data_4 = {
                                                ID_FPB: data_1[i].ID_FPB,
                                                ID_FPB_FORM: data_1[i].ID_FPB_FORM,
                                                JUMLAH_QTY_GUDANG: jumlah_quantity,
                                                JUMLAH_QTY_SPPB: jumlah_qty_sppb
                                            };
                                            $.ajax({
                                                url: "<?php echo site_url('FPB_form/update_quantity_sppb') ?>",
                                                type: "POST",
                                                dataType: "JSON",
                                                data: form_data_4,
                                                success: function(data) {
        ...
        $('#btn_update_qty_fpb').on('click', function() {

            var form_data_3 = {
                ID_FPB: $('#ID_FPB8').val()
            };
            $.ajax({
                url: "<?php echo site_url('FPB_form/update_data_gudang_fpb') ?>",
                type: "POST",
                dataType: "JSON",
                data: form_data_3,
                success: function(data) {
