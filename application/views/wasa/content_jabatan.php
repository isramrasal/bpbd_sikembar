<div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="alert alert-info alert-dismissable">
				<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
				Sistem menampilkan jabatan internal dan eksternal. Anda hanya bisa menambahkan data internal.
			</div>
        ...
        <div class="modal inmodal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
				...
				<small class="font-bold">Silakan isi data jabatan secara lengkap</small>
			</div>
			<?php $attributes = array("nama_jabatan" => "contact_form", "id" => "contact_form");
            echo form_open("jabatan/simpan_data", $attributes);?>
				<div class="form-horizontal">
					<div class="modal-body">

						<div class="form-group">
							<label class="control-label col-xs-3" >Nama Jabatan Pekerjaan</label>
							<div class="col-xs-9">
								<input name="nama_jabatan" id="nama_jabatan" class="form-control" type="text" placeholder="Nama Jabatan Pekerjaan.." required autofocus>
							</div>
						</div>
        ...
        <div class="modal inmodal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
				...
				<i class="fa fa-suitcase modal-icon"></i>
				<h4 class="modal-title">Data Jabatan</h4>
				<small class="font-bold">Silakan edit data jabatan secara lengkap</small>
			</div>
            <?php $attributes = array("id_jabatan2" => "contact_form", "id" => "contact_form");
            echo form_open("jabatan/update_data", $attributes);?>
				<div class="form-horizontal">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<input name="id_jabatan2" id="id_jabatan2" class="form-control" type="text" placeholder="ID Jabatan" readonly>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3" >Nama Jabatan Pekerjaan</label>
							<div class="col-xs-9">
								<input name="nama_jabatan2" id="nama_jabatan2" class="form-control" type="text" placeholder="Nama Jabatan Pekerjaan.." required>
							</div>
						</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							...
							<div name="nama_jabatan_3" id="nama_jabatan_3"></div>
							</div>
    ...
    <script>
        $(document).ready(function(){
			...
			tampil_data_jabatan();	//pemanggilan fungsi tampil data.
					...
					success : function(data){
						...
						for(i=0; i<data.length; i++){
							html += '<tr>'+
									...
									'<td>'+data[i].NAMA+'</td>'+
									'<td>'+
										'<a href="javascript:;" class="btn btn-info btn-xs item_edit" data="'+data[i].ID_JABATAN+'"><i class="fa fa-pencil"></i> Edit </a>'+' '+
										'<a href="javascript:;" class="btn btn-danger btn-xs item_hapus" data="'+data[i].ID_JABATAN+'"><i class="fa fa-trash"></i> Hapus</a>'+
									'</td>'+
									'</tr>';
						}
						$('#show_data').html(html);
			...
			$('#show_data').on('click','.item_edit',function(){
				...
				$.ajax({
					type : "GET",
					url  : "<?php echo base_url('index.php/jabatan/get_data')?>",
					dataType : "JSON",
					data : {id:id},
					success: function(data){
				...
				$.ajax({
					...
					success: function(data){
						$.each(data,function(id_jabatan, nama_jabatan, keterangan){
							...
							$('[name="kode"]').val(id);
							$('#nama_jabatan_3').html('Jabatan Pekerjaan: ' + data.NAMA_JABATAN);
						});
					}
				});
			});
			...
			$('#btn_simpan').click(function() {
				...
				$.ajax({
					url: "<?php echo site_url('jabatan/simpan_data'); ?>",
					type: 'POST',
					data: form_data,
					success: function(data){
						if (data != '')
			...
			$('#btn_update').on('click',function(){
				...
				var nama_jabatan2=$('#nama_jabatan2').val();
				var keterangan2=$('#keterangan2').val();
				$.ajax({
					url  : "<?php echo site_url('jabatan/update_data')?>",
					type : "POST",
					dataType : "JSON",
					data : {id_jabatan2:id_jabatan2 , nama_jabatan2:nama_jabatan2, keterangan2:keterangan2},
					success: function(data){
						if (data == true)
						{
							$('#ModalaEdit').modal('hide');
							$('[name="id_jabatan2"]').val("");
							$('[name="nama_jabatan2"]').val("");
			...
			$('#btn_hapus').on('click',function(){
				...
				$.ajax({
				type : "POST",
				url  : "<?php echo base_url('index.php/jabatan/hapus_data')?>",
				dataType : "JSON",
						data : {kode: kode},
						success: function(data){
