		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<a href="<?php echo base_url('index.php/TOP/') ?>" class="btn btn-outline btn-info"> Atur Term of Payment</a>
					<br><br>
				...
				success: function(data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							'<td>' + html_status + '</td>' +
							'<td>' +
							'<a href="<?php echo base_url() ?>vendor/profil_vendor/' + data[i].HASH_MD5_VENDOR + '" class="btn btn-info btn-xs btn-outline block"><i class="fa fa-eye"></i> Lihat Data </a>' + ' ' +
							'<a href="javascript:;" class="btn btn-warning btn-xs item_edit block" data="' + data[i].ID_VENDOR + '"><i class="fa fa-pencil"></i> Ubah </a>' + ' ' +
