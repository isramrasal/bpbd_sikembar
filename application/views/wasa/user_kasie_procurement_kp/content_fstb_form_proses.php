    ...
    <div class="modal-dialog" style="width: 80vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <i class="fa fa-group modal-icon"></i>
                <h4 class="modal-title">Upload Foto/Gambar Item Barang/Jasa FSTB</h4>
                <small class="font-bold">Silakan Upload Foto/Gambar item barang/jasa FSTB</small>
            </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Download/Upload Dokumen FSTB Cap Basah</h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                        ...
                        <div class="ibox-content">
                            ...
                            <div id="show_data_3">
                                <div class="row">
                                    <div class="col-lg-12" id="show_data_4">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group"><label class="control-label col-xs-3">Tool/Consumable/<br>Material</label>
                        <div class="col-xs-9">
                            <input name="PERALATAN_PERLENGKAPAN5" id="PERALATAN_PERLENGKAPAN5" class="form-control" type="text" readonly>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="javascript:;" class="btn btn-primary btn-xs item_gambar block" data="' + data[i].ID_FSTB_FORM + '"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i>Upload Gambar</a>' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
        ...
        //GET UPDATE untuk edit jumlah
        $('#show_data').on('click', '.item_gambar', function() {
            var id = $(this).attr('data');

            $.ajax({
                type: "GET",
                url: "<?php echo base_url('FSTB_form/get_fstb_file') ?>",
                dataType: "JSON",
                data: {
                    id: id
                },
                success: function(data) {
                    ...
                    if (data.FILE == "TIDAK ADA") {
                        document.getElementById("show_data_2").style.display = 'inline';
                        document.getElementById("show_data_3").style.display = 'none';
                    } else {
                        document.getElementById("show_data_2").style.display = 'none';
                        document.getElementById("show_data_3").style.display = 'inline';
                        var html, html_gambar = '';
                        var i;

                        for (i = 0; i < data.dokumen.length; i++) {
                            if (data.dokumen[i].JENIS_FILE == "Gambar Produk") {
                                html_gambar = '"<div class="image"><img alt="image" class="img-responsive"src="https://localhost/project_eam/' + data.dokumen[i].KETERANGAN + '"></div>"';
                            } else {
                                html_gambar = '"<div class="icon"><i class = "fa fa-file"></i></div>"';
                            }

                            html += '<div class="file-box"><div class = "file"><a href = "#"><span class = "corner"></span>' + html_gambar + '<div class = "file-name"><a href = "https://localhost/project_eam/assets/upload_fstb_form_file/' + data.dokumen[i].DOK_FILE + '">Download file</a><br/><small>Jenis file:</small> ' + data.dokumen[i].JENIS_FILE + '<br/><small>Diupload:</small>' + data.dokumen[i].TANGGAL_UPLOAD + '</div></a></div></div>';
                        }
                        $('#show_data_4').html(html);
                    }
