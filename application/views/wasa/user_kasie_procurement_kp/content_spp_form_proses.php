                                ...
                                <div class="panel-body">
                                    <form method="get" class="form-horizontal">
                                        ...
                                        ?>
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label">Tanggal Aktual Pembuatan SPP:</label>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#ModalAddDariSPPB"><span class="fa fa-plus"></span> Tambah Item dari SPPB</a><br>
...
<!--END MODAL ADD FROM MASTER LIST-->
        ...
        <div class="modal-content animated bounceInRight">
            ...
            ?>
                <div class="modal-header">
                    ...
                    <small class="font-bold">Silakan isi data SPP berdasarkan daftar SPPB</small>
                </div>
                                    ...
                                    <tbody">
                                        ...
                                        foreach ($sppb_barang_list as $data) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>SPPB_form/view/<?php echo $data->HASH_MD5_SPPB; ?>" class="btn btn-warning btn-xs btn-outline block" target="_blank"><i class="fa fa-eye"></i> <?php echo $data->NO_URUT_SPPB; ?> </a>
                                                </td>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_KASIE_PROC_KP6" id="CTT_KASIE_PROC_KP6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '</td>' +
                            '<td>' +
                            '<a href="javascript:;" class="btn btn-warning btn-xs item_edit block" data="' + data[i].ID_SPP_FORM + '"><i class="fa fa-pencil"></i> Ubah </a>' + ' ' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_KASIE_PROC_KP);
        ...
        $('#btn_update_catatan_spp').on('click', function() {
            ...
            let CTT_KASIE_PROC_KP = $('#CTT_KASIE_PROC_KP6').val();
            $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_KASIE_PROC_KP6"]').val(data.CTT_KASIE_PROC_KP);
