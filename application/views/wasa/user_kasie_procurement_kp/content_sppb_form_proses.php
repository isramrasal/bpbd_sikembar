                        ...
                        <div class="panel-body">
                            ...
                            <div class="stream">
                                ...
                                <div class="stream-panel">
                                    <div class="stream-info">
                                        <a href="#">
                                            <span>Catatan Supervisor Logistik:</span>
                                        </a>
                                    </div>
                            ...
                            <div class="stream">
                                ...
                                <div class="stream-panel">
                                    <div class="stream-info">
                                        <a href="#">
                                            <span>Catatan Manajer Logistic:</span>
                                        </a>
                                    </div>
                            ...
                            <div class="stream">
                                ...
                                <div class="stream-panel">
                                    <div class="stream-info">
                                        <a href="#">
                                            <span>Catatan Manajer Procurement:</span>
                                        </a>
                                    </div>
                                    <?php echo $CATATAN_SPPB['CTT_M_PROC']; ?>
                                </div>
                            </div>
                            ...
                            <div class="stream">
                                ...
                                <div class="stream-panel">
                                    <div class="stream-info">
                                        <a href="#">
                                            <span>Catatan Direktur Konstruksi:</span>
                                        </a>
                                    </div>
                                    <?php echo $CATATAN_SPPB['CTT_D_KONS']; ?>
                                </div>
                            </div>
                            ...
                            <a href="javascript:;" id="item_edit_catatan_sppb" name="item_edit_catatan_sppb" class="btn btn-info" data="<?php echo $ID_SPPB; ?>"><i class="fa fa-comment"></i> Berikan Catatan SPPB </a>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <a href="<?php echo base_url('index.php/SPPB/') ?>" class="btn btn-primary"><span class="fa fa-save"></span> Simpan Perubahan & Kembali Ke Halaman List SPPB</a>
                            </br>
                            <a href="javascript:;" id="item_edit_kirim_sppb" name="item_edit_kirim_sppb" class="btn btn-warning" data="<?php echo $ID_SPPB; ?>"><span class="fa fa-send"></span> Ajukan SPPB ke Supervisor Logistic</a><br>
                        </div>
                    </div>
                </div>
            </div>
