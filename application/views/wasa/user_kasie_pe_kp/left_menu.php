					...
					<?php if ($left_menu == "dashboard_kasie_pe_kp_aktif") { ?>
						<li class="active">
							<a href="<?php echo base_url(); ?>index.php/Dashboard_kasie_pe_kp"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span> </a>
						</li>
					<?php } else { ?>
						<li>
							<a href="<?php echo base_url(); ?>index.php/Dashboard_kasie_pe_kp"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span> </a>
