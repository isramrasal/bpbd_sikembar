                ...
                <div class="tab-content">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="ID_PROYEK" class="form-control" id="ID_PROYEK">
                                            ...
                                            <?php foreach ($proyek as $proyek) {
                                                echo '<option value="' . $proyek->ID_PROYEK . '">' . $proyek->NAMA_PROYEK . ' - ' . $proyek->LOKASI . '</option>';
                                            } ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div id="tab-7" class="tab-pane">
                        <div class="panel-body">
                            ...
                            <button class="btn btn-primary" id="btn_update"><i class="fa fa-save"></i> Simpan Perviewan Data</button>
...
<script>
    ...
    function changeJenisKepemilikan() {
        ...
        if (status == 1 && PERALATAN_PERLENGKAPAN == 1) {
