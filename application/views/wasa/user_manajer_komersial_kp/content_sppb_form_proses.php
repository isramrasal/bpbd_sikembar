            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_M_KOMERSIAL6" id="CTT_M_KOMERSIAL6"  required></textarea>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_M_KOMERSIAL6"]').val(data.CTT_M_KOMERSIAL);
        ...
        let CTT_M_KOMERSIAL = $('#CTT_M_KOMERSIAL6').val();
        $.ajax({
