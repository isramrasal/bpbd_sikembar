            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <button class="btn btn-primary" id="btn_kirim_po"><i class="fa fa-arrow-left"></i> Kembali ke halaman list PO</button>
                            </br>
                        </div>
                    </div>
                </div>
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<tr>' +
                                ...
                                '<td>' + jumlah_barang + '</td>' +
                                '<td> Rp ' + data[i].HARGA_SATUAN_BARANG_FIX + '</td>' +
                                '<td> Rp ' + data[i].HARGA_TOTAL_FIX + '</td>' +
