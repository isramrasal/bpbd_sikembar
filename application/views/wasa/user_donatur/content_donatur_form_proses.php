...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('index.php/Donasi/') ?>">Donatur</a>
            </li>
            <li class="active">
                <strong>
                    <a>Form Donatur</a>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <!-- Identitas Form Donatur -->
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Formulir Pengisian Barang/Jasa Bantuan Donasi</h5>
        ...
        <div class="ibox-content">
            ...
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li class="" style="display:none;"><a data-toggle="tab" href="#tab-2">Catatan Donasi</a></li>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form method="get" class="form-horizontal">
                                <?php
                                if (isset($Donatur)) {
                                    foreach ($Donatur->result() as $Donatur):
                                        ?>
                                ...
                                <div class="form-group" id="data_TANGGAL_DOKUMEN_DONASI"><label
                                        class="col-sm-2 control-label">Tanggal Dokumen Donasi</label>
                                    <div class="col-sm-10">
                                        <?php
                                                if (empty($Donatur->TANGGAL_SURAT)) {
                                                ?>
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                id="TANGGAL_DOKUMEN_DONASI" name="TANGGAL_DOKUMEN_DONASI"
                                        ...
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                id="TANGGAL_DOKUMEN_DONASI" name="TANGGAL_DOKUMEN_DONASI"
                                                type="text" class="form-control" placeholder="dd/mm/yyyy"
                                                value="<?php echo $Donatur->TANGGAL_SURAT; ?>">
                                        </div>
                                        <?php
                                                }
                                                ?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Pemohon</label>
                                    <div class="col-sm-10"><input name="NAMA_PEMOHON" id="NAMA_PEMOHON" type="text"
                                            class="form-control" value="<?php echo $Donatur->Nama_Donatur; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Jabatan</label>
                                    <div class="col-sm-10"><input name="JABATAN" id="JABATAN" type="text"
                                            class="form-control" value="<?php echo $Donatur->Jabatan; ?>">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Instansi</label>
                                    <div class="col-sm-10"><input name="INSTANSI" id="INSTANSI" type="text"
                                            class="form-control" value="<?php echo $Donatur->Instansi; ?>">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Kampung Bencana</label>
                                    <div class="col-sm-10"><input name="KAMPUNG_BENCANA" id="KAMPUNG_BENCANA"
                                            ...
                                            value="<?php echo $Donatur->Kampung_Bencana; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Desa/Kelurahan</label>
                                    <div class="col-sm-10"><input name="DESA_KELURAHAN_BENCANA"
                                            ...
                                            value="<?php echo $Donatur->Desa_Kelurahan_Bencana; ?>">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Kecamatan</label>
                                    <div class="col-sm-10"><input name="KECAMATAN_BENCANA" id="KECAMATAN_BENCANA"
                                            type="text" class="form-control"
                                            value="<?php echo $Donatur->Kecamatan_Bencana; ?>">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Kabupaten/Kota</label>
                                    <div class="col-sm-10"><input name="KABUPATEN_KOTA_BENCANA"
                                            ...
                                            value="<?php echo $Donatur->Kabupaten_Kota_Bencana; ?>">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Kode Pos</label>
                                    <div class="col-sm-10"><input name="KODE_POS_BENCANA" id="KODE_POS_BENCANA"
                                            type="text" class="form-control"
                                            value="<?php echo $Donatur->Kode_Pos_Bencana; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="data_TANGGAL_KEJADIAN_BENCANA"><label
                                    ...
                                    <div class="col-sm-10">
                                        <?php
                                                if (empty($Donatur->TANGGAL_KEJADIAN_BENCANA)) {
                                                ?>
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                        ...
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                id="TANGGAL_KEJADIAN_BENCANA" name="TANGGAL_KEJADIAN_BENCANA"
                                                type="text" class="form-control" placeholder="dd/mm/yyyy"
                                                value="<?php echo $Donatur->TANGGAL_KEJADIAN_BENCANA; ?>">
                                        </div>
                                        <?php
                                                }
                                                ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Item Barang/Jasa Bantuan Donasi</h5>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <a href="<?php echo base_url('index.php/Donatur_forn/view/'); ?><?php echo $CODE_MD5; ?>"
                                class="btn btn-primary"><span class="fa fa-save"></span> Simpan Perubahan & View Dokumen
                                Pengajuan Donasi</a>
                            </br>
                            <a href="javascript:;" id="item_edit_kirim_donasi" name="item_edit_kirim_donasi"
                                class="btn btn-success" data="<?php echo $ID_FORM_INVENTARIS_BANTUAN_DONASI; ?>"><span
                                    class="fa fa-send"></span>
                                Ajukan Pengajuan Donasi Untuk Diproses </a><br>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    let ID_FORM_INVENTARIS_BANTUAN_DONASI = <?php echo $ID_FORM_INVENTARIS_BANTUAN_DONASI ?>;
    let CODE_MD5 = "<?php echo $CODE_MD5 ?>";
    let Nomor_Surat_Form_Inventaris = "<?php echo $Nomor_Surat_Form_Inventaris ?>";
    tampil_data_donatur_form(); //pemanggilan fungsi tampil data.
    ...
    //fungsi tampil data
    function tampil_data_donatur_form() {

        $.ajax({
            type: 'POST',
            url: '<?php echo base_url() ?>Donatur_form/data_barang_bantuan_form',
            async: false,
            dataType: 'json',
            data: {
                ID_FORM_INVENTARIS_BANTUAN_DONASI: ID_FORM_INVENTARIS_BANTUAN_DONASI
            },
    ...
    item_edit_kirim_donasi.onclick = function() {
    ...
    $('#btn_simpan_data_1_item').click(function() {
        ...
        $.ajax({
            url: "<?php echo site_url('Donatur_form/simpan_data_barang_bantuan'); ?>",
            type: 'POST',
            data: form_data,
            success: function(data) {
                if (data != '') {
