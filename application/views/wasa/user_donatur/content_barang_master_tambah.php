                     ...
                     <div class="panel-body">
                         ...
                         <fieldset class="form-horizontal">
                             ...
                             <div class="form-group"><label class="col-sm-2 control-label">Kode Barang (Generate by System)</label>
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" placeholder="Contoh : VE-2102" value="" name="KODE_BARANG" id="KODE_BARANG">
                                 </div>
                             </div>
                             <div class="form-group"><label class="col-sm-2 control-label">Masa Pakai</label>
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" placeholder="Contoh : 4 Tahun" name="MASA_PAKAI" id="MASA_PAKAI" required>
                                 </div>
                             </div>
                         </fieldset>
                     </div>
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     if (data != '') {
                         ...
                         // $('[name="ALIAS"]').val("");
                         // $('[name="MEREK"]').val("");
                         // $('[name="JENIS_BARANG"]').val("");
                         // $('[name="PERALATAN_PERLENGKAPAN"]').val("");
                         // $('[name="GROSS_WEIGHT"]').val("");
                         // $('[name="NETT_WEIGHT"]').val("");
                         // $('[name="DIMENSI_PANJANG"]').val("");
                         // $('[name="DIMENSI_LEBAR"]').val("");
                         // $('[name="DIMENSI_TINGGI"]').val("");
                         // $('[name="SPESIFIKASI_LENGKAP"]').val("");
