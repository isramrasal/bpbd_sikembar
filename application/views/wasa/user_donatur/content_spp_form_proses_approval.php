            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_STAFF_PROC_KP6" id="CTT_STAFF_PROC_KP6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn_update_catatan_spp').on('click', function() {
            ...
            let CTT_STAFF_PROC_KP = $('#CTT_STAFF_PROC_KP6').val();
            $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_STAFF_PROC_KP6"]').val(data.CTT_STAFF_PROC_KP);
