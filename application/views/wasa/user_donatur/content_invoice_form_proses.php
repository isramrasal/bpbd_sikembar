                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <form method="get" class="form-horizontal">
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Nomor Urut SPP:</label>
                                            <div class="col-sm-10">
                                                <?php
                                                if (empty($ID_SPP)) {
                                                ?>
                                                    <select class="form-control" name="ID_SPP" id="ID_SPP">
                                                        ...
                                                        <?php foreach ($SPP as $prov) {
                                                            echo '<option value="' . $prov->ID_SPP . '">' . $prov->NO_URUT_SPP . '</option>';
                                                        } ?>
                                                ...
                                                ?>
                                                    <select class="form-control" name="ID_SPP" id="ID_SPP">
                                                        <option value=''>- Pilih SPP -</option>
                                                        <?php foreach ($SPP as $prov) {
                                                            if ($prov->ID_SPP == $ID_SPP) {
                                                                echo '<option selected="selected" value="' . $prov->ID_SPP . '">' . $prov->NO_URUT_SPP . ' </option>';
                                                            } else {
                                                                echo '<option value="' . $prov->ID_SPP . '">' . $prov->NO_URUT_SPP . ' </option>';
                                                            }
                                                        } ?>
                        ...
                        <div class="ibox-content">
                            <div class="form-group">
                                <div class="sm-10">
                                    ...
                                    <a href="javascript:;" id="item_edit_kirim_po" name="item_edit_kirim_po" class="btn btn-success" data="<?php echo $ID_PO; ?>"><span class="fa fa-send"></span> Ajukan PO Untuk Proses Selanjutnya </a><br>
                                    </br>
                                </div>
                            </div>
                        </div>
