...
<!-- MODAL SIMPAN FPB -->
<div class="modal inmodal fade" id="ModalFPB" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog" style="width: 80vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <i class="fa fa-save modal-icon"></i>
                <h4 class="modal-title">Simpan FPB</h4>
                <small class="font-bold">Silakan isi catatan FPB dan Simpan Perubahan</small>
            </div>
            <!-- exclamation-triangle -->
            <div class="form-horizontal">
                <div class="modal-body">

                    <form method="POST" action="<?php echo site_url('FPB/simpan_perubahan_fpb'); ?>" id="formSimpanFPB">
                        <div class="form-group">
                            <div class="col-sm-12">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close"></i> Batal</button>
                    <button class="btn btn-primary" type="submit" form="formSimpanFPB"><i class="fa fa-save"></i> Tambah</button>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Justifikasi Item Barang</label>
                        <div class="col-xs-9">
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox" id="saya_setuju"><i></i> Saya telah selesai melalukan proses form FPB ini dan menyetujui untuk diproses lebih lanjut </label></div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#modalmaster').dataTable({
            pageLength: 1000,
            responsive: true,
            lengthMenu: [0, 5, 10, 20, 50, 100, 200, 500, 1000, 2000, 3000],
        });
        $('#modalrasd').dataTable({
            pageLength: 1000,
            responsive: true,
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="javascript:;" class="btn btn-danger btn-xs item_hapus block" data="' + data[i].ID_FPB_FORM + '"><i class="fa fa-trash"></i> Hapus</a>' +
                            '</td>' +
                            '<td>' +
                            '<a href="javascript:;" class="btn btn-success btn-xs item_edit_justifikasi block" data="' + data[i].ID_FPB_FORM + '"><i class="fa fa-comment  "></i> Justifikasi </a>' + ' ' +
                            '</td>' +
