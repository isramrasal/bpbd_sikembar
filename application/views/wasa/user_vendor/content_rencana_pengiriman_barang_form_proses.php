        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Formulir Pengajuan Delivery Plan</h5>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="panel-body">
                                <form method="get" class="form-horizontal">
                                    ...
                                    ?>
                                            <div class="form-group"><label class="col-sm-2 control-label">No Urut Delivery Plan:</label>
                        ...
                        <div class="ibox-content">
                            <div class="form-horizontal">
                                ...
                                <div class="alert alert-warning alert-dismissable">
                                    <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                    Perubahan data pada form Delivery Plan tidak akan mempengaruhi data pada form PO.
                                </div>
    ...
    <div class="modal-dialog" style="width: 80vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delivery Plan</h4>
    ...
    <div class="modal-dialog" style="width: 30vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Kirim Delivery Plan</h4>
                <small class="font-bold">Selesaikan proses dan kirim Form Delivery Plan ini untuk proses selanjutnya</small>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="show_hidden_setuju" class="form-group" hidden>
                        <div class="i-checks"><input type="checkbox" id="saya_setuju">
                            Saya telah selesai melakukan proses form Delivery Plan ini dan menyetujui untuk diproses lebih lanjut
                        </div>
                    </div>
