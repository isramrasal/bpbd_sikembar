<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('RFQ/') ?>">RFQ</a>
            </li>
            <li class="active">
                <strong>
                    <a>Form RFQ</a>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <!-- Identitas Form QUOTATION -->
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><?php echo $FILE_NAME_TEMP_QUOTATION; ?></h5>
        ...
        <div class="ibox-content">
            <div class="container_iframe">
                <iframe class="responsive-iframe" src="<?php echo base_url('assets/Quotation/') ?><?php echo $FILE_NAME_TEMP_QUOTATION; ?>"></iframe>
            </div>
            </br>
            <a href="<?php echo base_url('RFQ') ?>" class="btn btn-info"> Kembali Ke Halaman List RFQ</a>
            <?php if ($PROGRESS_QUOTATION == "FINAL") { ?>
                <a href="<?php echo base_url('RFQ') ?>" class="btn btn-warning" disabled><span class="fa fa-pencil"></span> Proses Quotation </a>
            <?php
            } else { ?>
                <a href="<?php echo base_url('Quotation_form/index/') ?><?php echo $HASH_MD5_QUOTATION; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Proses Quotation </a>
            <?php
            } 
            ?>
        </div>
    ...
    <?php if ($FILE == "ADA") { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Dokumen Quotation - Vendor</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
            ...
            <div class="ibox-content">
                ...
                <!-- <a href="javascript:;" id="item_edit_upload_gambar" name="item_edit_upload_gambar" class="btn btn-primary" data="<?php echo $HASH_MD5_QUOTATION; ?>"><i class="fa fa-upload" aria-hidden="true"></i> Upload Dokumen Quotation Cap Basah</a> -->
            </div>
        </div>
    <?php } else { ?>
        <div class="ibox float-e-margins">
    ...
    $(document).ready(function() {
        if (document.getElementById('dropzoneForm')) {
            var file_upload = new Dropzone(".dropzone", {
                url: "<?php echo base_url('RFQ_form/proses_upload_file') ?>",
                maxFilesize: 1,
                method: "post",
