    ...
    <?php if ($FILE == "ADA") { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Dokumen Invoice - Vendor</h5>
            ...
            <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <?php foreach ($dokumen as $po_form_file) {
                                    if ($po_form_file->JENIS_FILE == "Dokumen Surat Jalan Cap Basah" || $po_form_file->JENIS_FILE == "Dokumen Serah Terima Cap Basah" || $po_form_file->JENIS_FILE == "Dokumen Invoice Cap Basah" || $po_form_file->JENIS_FILE == "Dokumen Lainnya - Vendor") { ?>
										...
										<i class='fa fa-file'></i>
                                                    ...
                                                    <input type="button" class="btn btn-block btn-outline btn-danger" onclick="location.href='<?php echo base_url(); ?>index.php/po_form/hapus_file_invoice/<?php echo $po_form_file->DOK_FILE; ?>';" value="Hapus" />
                                                </a>
                                            </div>
                                        </div>
                ...
                <a href="javascript:;" id="item_edit_upload_gambar" name="item_edit_upload_gambar" class="btn btn-primary" data="<?php echo $HASH_MD5_PO; ?>"><i class="fa fa-upload" aria-hidden="true"></i> Upload Dokumen Invoice Cap Basah</a>
            </div>
        </div>

        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download Dokumen PO - Dept Procurement</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
                ...
                <div class="row">
                    <div class="col-lg-9 animated fadeInRight">
                        <div class="row">
                            <div class="col-lg-12">
                                <?php foreach ($dokumen as $po_form_file) {
                                    if ($po_form_file->JENIS_FILE == "Dokumen Cap Basah" || $po_form_file->JENIS_FILE == "Dokumen Lainnya - Dept Proc") { ?>
