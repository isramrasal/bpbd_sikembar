...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <a href="<?php echo base_url('RFQ_form/input_harga/') ?><?php echo $HASH_MD5_RFQ; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Ubah RFQ</a>
        </div>
    </div>
    ...
    <?php if ($FILE == "ADA") { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Dokumen RFQ - Vendor</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
                                ...
                                <?php foreach ($dokumen as $rfq_form_file) {
                                    if ($rfq_form_file->JENIS_FILE == "Dokumen List Harga" || $rfq_form_file->JENIS_FILE == "Dokumen Lainnya - Vendor") { ?>
										...
										<i class='fa fa-file'></i>
                                                    ...
                                                    <input type="button" class="btn btn-block btn-outline btn-danger" onclick="location.href='<?php echo base_url(); ?>rfq_form/hapus_file/<?php echo $rfq_form_file->DOK_FILE; ?>';" value="Hapus" />
                                                </a>
                                            </div>
                                        </div>
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download Dokumen RFQ - Dept Procurement</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
    ...
    <div class="modal-dialog" style="width: 80vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Dokumen RFQ</h4>
                <small class="font-bold">Silakan Upload Dokumen RFQ</small>
            </div>
            <div class="form-horizontal">
                <div class="modal-body">
