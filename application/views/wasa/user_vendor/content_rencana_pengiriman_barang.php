<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>List Delivery Plan</h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url('index.php') ?>">Home</a>
            </li>
            <li>
                <a href="<?php echo base_url('index.php/Rencana_Pengiriman_Barang/') ?>">Delivery Plan</a>
            </li>
            <li class="active">
                <strong>
                    <a>List Delivery Plan</a>
                </strong>
            </li>
        </ol>
    </div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">Nomor Urut Delivery Plan:</label>
                        <div class="col-xs-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="NAMA_PENGIRIM" id="NAMA_PENGIRIM" placeholder="Contoh : Budi Utama" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="NO_HP_PENGIRIM" id="NO_HP_PENGIRIM" placeholder="Contoh : 087808780878" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="KEPADA" id="KEPADA" placeholder="Contoh : PT. Wasa Mitra Enginering" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-xs-3 control-label">Alamat Tujuan:</label>
                        <div class="col-xs-9">
                            <textarea class="form-control" name="TUJUAN" id="TUJUAN" placeholder="Contoh : JL. Raya Cakung Cilincing, Km 1 No.11 Gedung WASA, RT.11/RW.7, Cakung Bar., Kec. Cakung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13910"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox" id="saya_setuju"><i></i> Saya telah selesai melakukan proses identitas form Delivery Plan ini dan menyetujui untuk proses selanjutnya </label></div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" name="btn_simpan" id="btn_simpan" disabled><i class="fa fa-save"></i> Buat Delivery Plan</button>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        document.querySelector("#TANGGAL_RENCANA_PENGIRIMAN_BARANG_HARI").valueAsDate = new Date();
                            ...
                            success: function(data) {
                                ...
                                if (data_2 == 'TIDAK ADA DATA') {
                                    ...
                                    for (j = 0; j < data_2.length; j++) {
                                        var html_progress = '';
                                        html_progress = data_2[j].TANGGAL_RENCANA_PENGIRIMAN_BARANG_HARI;
                                ...
                                if (data_2 == 'TIDAK ADA DATA') {
                                    ...
                                    for (j = 0; j < data_2.length; j++) {
                                        var html_progress = '';
                                        html_progress = data_2[j].NAMA_PENGIRIM;
                                        html += '<a href="#" class="btn btn-link btn-xs btn-block text-decoration-none"> ' + html_progress + "</br>";
                                    }
                                ...
                                if (data_2 == 'TIDAK ADA DATA') {
                                    ...
                                    for (j = 0; j < data_2.length; j++) {
                                        var html_progress = '';
                                        html_progress = data_2[j].NO_HP_PENGIRIM;
                                        html += '<a href="#" class="btn btn-link btn-xs btn-block text-decoration-none"> ' + html_progress + "</br>";
                                    }
                                ...
                                html += '<a href="javascript:;" class="btn btn-info btn-xs item_buat_po_baru" data="' + data_1[i].HASH_MD5_PO + '"><i class="fa fa-plus"></i> Buat Delivery Plan </a>' + ' ' +
                                    '</td>' +
                                    '</tr>';
                            }
                        });
                            ...
                            success: function(data) {
                                $.each(data, function() {
                                    if (data == 'BELUM ADA RPB') {
                                        ...
                                        window.location.href = '<?php echo base_url(); ?>index.php/Rencana_Pengiriman_Barang_form/index/' + data.HASH_MD5_RENCANA_PENGIRIMAN_BARANG;
                                    }
                                });
                            }
                        });
