 ...
 1536;width:32pt'>
  ...
  width:144pt'>: <?php echo $NAMA_LOKASI_PENYERAHAN; ?></td>
					...
					<tr height=26 style='height:19.2pt'>
						<td height=26 class=xl7821533 style='height:19.2pt;width:50%;border-top:none'>No.</td>
						<td class=xl6721533 width=64 style='border-top:none;border-left:none;
  width:48pt'>Nama Barang</td>
						<td colspan=2 class=xl6821533 width=128 style='width:96pt'>Spesifikasi</td>
						<td class=xl6921533 width=64 style='border-top:none;width:48pt'>Jenis Barang</td>
  ...
  border-left:none;width:96pt'>Total</td>
					...
					?>
							<tr height=22 style='mso-height-source:userset;height:16.5pt'>
								<td height=22 class=xl7221533 width=43 style='height:16.5pt;border-top:none;
  width:32pt'><?php echo $hitung; ?></td>
								<td class=xl7021533 width=64 style='border-top:none;border-left:none;
  width:48pt'><?php echo $item->NAMA_BARANG; ?></td>
								<td colspan=2 class=xl10421533 width=128 style='border-right:.5pt solid black;
  border-left:none;width:96pt'><?php echo $item->SPESIFIKASI_SINGKAT;
								?></td>
								<td class=xl7121533 width=64 style='border-top:none;width:48pt'><?php echo
																								$item->NAMA_JENIS_BARANG; ?></td>
								<td class=xl7221533 width=64 style='border-top:none;border-left:none;
  ...
  border-left:none;width:96pt'>Rp. <?php echo
									number_format(
  ...
  border-left:none;width:96pt'>Rp. <?php echo number_format($item->TOTAL_ALL_PO_BARANG, 2, ",", "."); ?></td>
					...
					<tr height=19 style='mso-height-source:userset;height:14.4pt'>
						<td colspan=2 height=19 class=xl12021533 style='height:14.4pt'>KONDISI
							PENGADAAN:</td>
  ...
  width:512pt'>isi teks</td>
					...
					<tr height=19 style='height:14.4pt'>
						...
						<td class=xl7521533 width=64 style='width:48pt'></td>
						<td class=xl7621533></td>
						<td colspan=2 class=xl7821533>Disetujui Oleh,</td>
						<td colspan=2 class=xl7821533 style='border-left:none'>Disiapkan Oleh,</td>
						<td class=xl6321533></td>
						<td class=xl6321533></td>
						<td class=xl6321533></td>
					</tr>
