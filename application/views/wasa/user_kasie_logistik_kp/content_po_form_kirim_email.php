                ...
                <div class="ibox-content">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Isi body email:</label>
                            <div class="col-sm-10">
                            <textarea style="width:100%" rows="12" name="SALAM_PEMBUKA" id="SALAM_PEMBUKA" required>Terlampir file PO dari kami. Mohon untuk memberikan penawaran harga melalui link berikut:
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <button class="btn btn-primary" id="btn_kirim_po"><i class="fa fa-save"></i> Kirim Email PO</button>
                            </br>
                        </div>
                    </div>
                </div>
