                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="form-group">
                            <div class="sm-10">
                                <!-- <button class="btn btn-primary" id="btn_simpan_perubahan_pdf"><i class="fa fa-save"></i> Simpan Perubahan & View Dokumen SPP</button> -->
            ...
            <div class="modal-dialog" style="width: 60vw;">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Lanjutkan Proses SPP</h4>
                        <small class="font-bold">Selesaikan pengisian Form SPP ini untuk proses selanjutnya</small>
                    </div>
                    <div class="form-horizontal">
                        <div class="modal-body">
