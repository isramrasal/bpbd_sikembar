...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="alert alert-info alert-dismissable">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
        Sistem menampilkan seluruh FPB yang Anda ajukan pada proyek <?php echo ($NAMA_PROYEK); ?>.
    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function() {
                    ...
                    $('[name="NO_URUT_FPB"]').val(`${NO_URUT}/FPB/WME/${INISIAL}/${SUB_DEPARTEMEN}/2021`);
                    $('[name="FILE_NAME_TEMP"]').val(`${NO_URUT}_FPB_WME_${INISIAL}_${SUB_DEPARTEMEN}_2021`);
                });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (PROGRESS_FPB == "Dalam Proses Staff Logistik") {
                            tombol_ubah = '<a href="#" class="btn btn-warning btn-xs block" disabled><i class="fa fa-pencil"></i> Ubah </a>';
                        } else {
                            tombol_ubah = '<a href="<?php echo base_url() ?>FPB_form/index/' + data[i].HASH_MD5_FPB + '" class="btn btn-warning btn-xs block"><i class="fa fa-pencil"></i> Ubah </a>';
                        }
