                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Nama PIC Vendor:</label>
                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $NAMA_PIC_VENDOR; ?>"></div>
                        </div>

                        <div class="form-group"><label class="col-sm-2 control-label">Email PIC Vendor:</label>
                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $EMAIL_PIC_VENDOR; ?>"></div>
                        </div>

                        <div class="form-group"><label class="col-sm-2 control-label">Batas akhir pengisian RFQ:</label>
                            <div class="col-sm-10">
                                <input name="BATAS_AKHIR" id="BATAS_AKHIR" class="form-control" type="date">
                            </div>
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Salam pembuka email:</label>
                            <div class="col-sm-10">
                                <textarea style="width:100%" rows="12" name="SALAM_PEMBUKA" id="SALAM_PEMBUKA" required>Yth. Bapak/ibu <?php echo $NAMA_PIC_VENDOR; ?>, <?php echo $NAMA_VENDOR; ?>
                            </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Isi body email:</label>
                            <div class="col-sm-10">
                                <textarea style="width:100%" rows="12" name="SALAM_PEMBUKA" id="SALAM_PEMBUKA" required>Terlampir file RFQ dari kami. Mohon untuk memberikan penawaran harga melalui link berikut:
                            Link hanya bisa diakses sampai dengan:
                            Terima kasih.
                            </textarea>
                            </div>
                        </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <button class="btn btn-primary" id="btn_kirim_rfq"><i class="fa fa-save"></i> Kirim Email RFQ</button>
                            </br>
                        </div>
                    </div>
                </div>
