            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_MAN_LOG_KP6" id="CTT_MAN_LOG_KP6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_MAN_LOG_KP6"]').val(data.CTT_MAN_LOG_KP);
        ...
        $('#btn_update_catatan_surat_jalan').on('click', function() {
            ...
            let CTT_MAN_LOG_KP = $('#CTT_MAN_LOG_KP6').val();
            $.ajax({
