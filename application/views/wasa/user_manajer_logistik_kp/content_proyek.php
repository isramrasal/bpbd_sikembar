		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#ModalAdd"><span class="fa fa-plus"></span> Tambah Data</a><br><br>
		...
		<div class="modal-content animated bounceInRight">
			...
			<div class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group" id="data_TANGGAL_MULAI_PROYEK">
                        <label class="col-xs-3 control-label">Tanggal Mulai Proyek</label>
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                    name="TANGGAL_MULAI_PROYEK" id="TANGGAL_MULAI_PROYEK" type="text"
                                    class="form-control" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                    </div>

					<div class="form-group" id="data_TANGGAL_SELESAI_PROYEK">
                        <label class="col-xs-3 control-label">Tanggal Selesai Proyek</label>
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                    name="TANGGAL_SELESAI_PROYEK" id="TANGGAL_SELESAI_PROYEK" type="text"
                                    class="form-control" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                    </div>
		...
		<div class="modal-content animated bounceInRight">
			...
			<div class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group" id="data_TANGGAL_MULAI_PROYEK_2">
                        <label class="col-xs-3 control-label">Tanggal Mulai Proyek</label>
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                    name="TANGGAL_MULAI_PROYEK2" id="TANGGAL_MULAI_PROYEK2" type="text"
                                    class="form-control" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                    </div>

					<div class="form-group" id="data_TANGGAL_SELESAI_PROYEK_2">
                        <label class="col-xs-3 control-label">Tanggal Selesai Proyek</label>
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                    name="TANGGAL_SELESAI_PROYEK2" id="TANGGAL_SELESAI_PROYEK2" type="text"
                                    class="form-control" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                    </div>
...
<script>
	$(document).ready(function() {
		...
		$('#data_TANGGAL_MULAI_PROYEK .input-group.date').datepicker({
            todayBtn: "linked",
		...
		$('#data_TANGGAL_SELESAI_PROYEK .input-group.date').datepicker({
            todayBtn: "linked",
            keyboardNavigation: false,
            forceParse: false,
            calendarWeeks: true,
		...
		$('#data_TANGGAL_MULAI_PROYEK_2 .input-group.date').datepicker({
            todayBtn: "linked",
            keyboardNavigation: false,
            forceParse: false,
            calendarWeeks: true,
		...
		$('#data_TANGGAL_SELESAI_PROYEK_2 .input-group.date').datepicker({
            todayBtn: "linked",
            keyboardNavigation: false,
            forceParse: false,
            calendarWeeks: true,
				...
				success: function(data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							html_status +
							'<td>' +
							'<a href="<?php echo base_url() ?>Proyek/detil_proyek/' + data[i].HASH_MD5_PROYEK + '" class="btn btn-primary btn-xs btn-outline block"><i class="fa fa-eye"></i> Lihat Data </a>' + ' ' +
		...
		$('#btn_simpan').click(function() {
			var TANGGAL_MULAI_PROYEK = $('#TANGGAL_MULAI_PROYEK').val(),
				TANGGAL_MULAI_PROYEK = TANGGAL_MULAI_PROYEK.split("/").reverse().join("-");

            var TANGGAL_SELESAI_PROYEK = $('#TANGGAL_SELESAI_PROYEK').val(),
				TANGGAL_SELESAI_PROYEK = TANGGAL_SELESAI_PROYEK.split("/").reverse().join("-");
			...
			var form_data = {
				...
				TANGGAL_MULAI_PROYEK: TANGGAL_MULAI_PROYEK,
				TANGGAL_SELESAI_PROYEK: TANGGAL_SELESAI_PROYEK
		...
		$('#btn_update').on('click', function() {
			...
			var TANGGAL_MULAI_PROYEK2 = $('#TANGGAL_MULAI_PROYEK2').val(),
				TANGGAL_MULAI_PROYEK2 = TANGGAL_MULAI_PROYEK2.split("/").reverse().join("-");

            var TANGGAL_SELESAI_PROYEK2 = $('#TANGGAL_SELESAI_PROYEK2').val(),
				TANGGAL_SELESAI_PROYEK2 = TANGGAL_SELESAI_PROYEK2.split("/").reverse().join("-");
