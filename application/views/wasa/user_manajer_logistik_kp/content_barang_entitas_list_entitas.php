				...
				<div class="modal-body">
					...
					<?php if ($PERALATAN_PERLENGKAPAN == ("CONSUMABLE")) { ?>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<div>
									<select name="QUANTITY_ENTITAS" id="QUANTITY_ENTITAS" class="form-control" disabled>
										<?php
										for ($i = 1; $i <= 100; $i++) {
										?>
					...
					<div class="form-group">
						<label class="control-label col-xs-3">Kode Barang Entitas Sampai Dengan</label>
						<div class="col-xs-9">
							<div>
			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function() {
						...
						{
							SAMPAI_DENGAN = 0 + parseInt(SELANG);
						}
						else
						{
						...
						$('[name="JUMLAH_COUNT"]').val(data.JUMLAH_COUNT);
