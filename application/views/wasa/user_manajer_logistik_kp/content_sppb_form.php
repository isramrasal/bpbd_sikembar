...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_SPPB == "Dalam Proses Manajer Kantor Pusat") { ?>
            ...
            <?php
            } else if ($PROGRESS_SPPB == "Dalam Proses Pembuatan Manajer Logistik KP") { ?>
            ...
            ?>
                <a href="<?php echo base_url('index.php/SPPB/') ?>" class="btn btn-warning" disabled><span class="fa fa-pencil"></span> Ubah PO</a>
                <a href="javascript:;" id="item_edit_kirim_sppb" name="item_edit_kirim_sppb" class="btn btn-success" data="<?php echo $ID_SPPB; ?>" disabled><span class="fa fa-send"></span> Ajukan SPPB Untuk Proses Selanjutnya </a>
            <?php }
            ?>
        </div>
    </div>
    ...
    <?php if ($FILE == "ADA") { ?>
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Download/Upload Dokumen SPPB</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
                                ...
                                <?php foreach ($dokumen as $sppb_form_file) {
                                    if ($sppb_form_file->JENIS_FILE == "Dokumen Cap Basah" || $sppb_form_file->JENIS_FILE == "Dokumen Lainnya") { ?>
										...
										<i class='fa fa-file'></i>
                                                    ...
                                                    <div class="file-name">
                                                        <a href="<?php echo base_url(); ?>assets/upload_po_form_file/<?php echo $sppb_form_file->DOK_FILE; ?>">Download file</a>
                                                        <br />
                                                        <small>Jenis file: <?php echo $sppb_form_file->JENIS_FILE; ?></small>
                                                        <br />
                                                        <small>Diupload: <?php echo $sppb_form_file->TANGGAL_UPLOAD; ?></small>
                                                    </div>
                                                    <input type="button" class="btn btn-block btn-outline btn-danger" onclick="location.href='<?php echo base_url(); ?>index.php/po_form/hapus_file/<?php echo $sppb_form_file->DOK_FILE; ?>';" value="Hapus" />
                                                </a>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog" style="width: 80vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Dokumen SPPB Cap Basah</h4>
                <small class="font-bold">Silakan Upload Dokumen SPPB Cap Basah</small>
            </div>
            <div class="form-horizontal">
                <div class="modal-body">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <ul class="sortable-list connectList agile-list" id="ketentuan">
                                        ...
                                        <li class="danger-element" id="task2">
                                            2. Ukuran dokumen yang diterima sistem maksimal 100 Mega Bytes (100 MB).
                                        </li>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let PROGRESS_SPPB = "<?php echo $PROGRESS_SPPB ?>";
        ...
        item_edit_kirim_sppb.onclick = function() {
            var PROGRESS_SPPB = "<?php echo $PROGRESS_SPPB  ?>";
            if (PROGRESS_SPPB == "Dalam Proses Manajer Logistik KP") {
