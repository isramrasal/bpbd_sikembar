            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_M_LOG6" id="CTT_M_LOG6" required></textarea>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_STAFF_LOG_KP);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_M_LOG6"]').val(data.CTT_M_LOG);
