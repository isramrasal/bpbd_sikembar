...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="alert alert-info alert-dismissable">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
        Sistem menampilkan seluruh FSTB yang Anda ajukan pada seluruh proyek.
    </div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#ModalAdd"><span class="fa fa-plus"></span> Buat Form Serah Terima Barang</a>
                    <br>
                    <br>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="mydata">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama Pegawai Penerima Barang</th>
...
<div class="modal inmodal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog" style="width: 40vw;">
        <div class="modal-content animated bounceInRight">
            ...
            <input type="hidden" class="form-control" value="<?php echo ($ID_PROYEK_SERAH_TERIMA); ?>" name="ID_PROYEK_SERAH_TERIMA" id="ID_PROYEK_SERAH_TERIMA" disabled />
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <select name="SUMBER_PENERIMAAN" class="form-control" id="SUMBER_PENERIMAAN">
                    ...
                    <div id="show_hidden_nsj_1" class="form-group" hidden>
                        ...
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_SURAT_JALAN_1" id="ID_SURAT_JALAN_1">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="show_hidden_np_2" class="form-group" hidden>
                        <label class="col-xs-3 control-label">Nama Proyek:</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_PROYEK_2" id="ID_PROYEK_2">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="show_hidden_po_2" class="form-group" hidden>
                        ...
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_PO_2" id="ID_PO_2">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="show_hidden_np_3" class="form-group" hidden>
                        <label class="col-xs-3 control-label">Nama Proyek:</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_PROYEK_3" id="ID_PROYEK_3">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="show_hidden_po_3" class="form-group" hidden>
                        <label class="col-xs-3 control-label">Nomor PO:</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_PO_3" id="ID_PO_3">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="show_hidden_nv_3" class="form-group" hidden>
                        <label class="col-xs-3 control-label">Nama Vendor:</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="ID_VENDOR_3" id="ID_VENDOR_3">
                            </select>
                        </div>
                    </div>
...
<script>
    $('#ModalAdd').on('shown.bs.modal', function(e) {
        ...
        var ID_PROYEK_SERAH_TERIMA = $('#ID_PROYEK_SERAH_TERIMA').val();
        var INISIAL = $('#INISIAL').val();

        var id = ID_PROYEK_SERAH_TERIMA;
        var COUNT = "";
        var NO_URUT = "";
        var DEPAN = "";
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].PROGRESS_FSTB == "Dalam Proses Pembuatan Manajer Logistik KP") {
                            html_progress = '<a href="#" class="btn btn-info btn-xs block"> ' + data[i].PROGRESS_FSTB + ' </a>';
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-warning btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a><a href="<?php echo base_url() ?>index.php/Catat_stok_gudang_form/index/' + data[i].HASH_MD5_FSTB + '" class="btn btn-primary btn-xs block"><i class="fa fa-plus"></i> Catat Stok Gudang </a>';
                        } else if (data[i].PROGRESS_FSTB == "FSTB Disetujui") {
                            html_progress = '<a href="#" class="btn btn-primary btn-xs block"> ' + data[i].PROGRESS_FSTB + ' </a>';
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a> </br><a href="<?php echo base_url() ?>index.php/Catat_stok_gudang_form/index/' + data[i].HASH_MD5_FSTB + '" class="btn btn-primary btn-xs block"><i class="fa fa-plus"></i> Catat Stok Gudang </a>';
                        } else {
                            html_progress = '<a href="#" class="btn btn-info btn-outline btn-xs block"> ' + data[i].PROGRESS_FSTB + ' </a>';
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a></br><a href="<?php echo base_url() ?>index.php/Catat_stok_gudang_form/index/' + data[i].HASH_MD5_FSTB + '" class="btn btn-primary btn-xs block"><i class="fa fa-plus"></i> Catat Stok Gudang </a>';
                        }
        ...
        $('#btn_simpan').click(function() {
            let form_data = {
                ...
                ID_PROYEK_2: $('#ID_PROYEK_2').val(),
                ID_PROYEK_3: $('#ID_PROYEK_3').val(),
                ID_VENDOR_2: $('#ID_VENDOR_2').val(),
                ID_VENDOR_3: $('#ID_VENDOR_3').val(),
                ID_PROYEK_SERAH_TERIMA: $('#ID_PROYEK_SERAH_TERIMA').val(),
