								...
								<div class="row">
									...
									<div class="col-md-7">
										...
										<dl class="m-t-md">
											...
											<dt>Tool/Consumable/Material:</dt>
											<dd><?php echo $data_barang_master->PERALATAN_PERLENGKAPAN ?></dd><br>
											<dt>Satuan Barang:</dt>
							...
							<div class="file-box">
								<div class="file">
									<a href="#">
										...
										<div class="file-name">
											<a href="<?php echo base_url(); ?>assets/upload_barang_master_file/<?php echo $barang_master_file->DOK_FILE; ?>"target="_blank">Download file</a>
											<br />
