        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <a href="<?php echo base_url(); ?>index.php/barang_master/tambah" class="btn btn-success"><span class="fa fa-plus"></span> Tambah Data</a><br><br>
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<tr>' +
                            ...
                            '</td>' +
                            '<td>' +
                            '<a href="<?php echo base_url() ?>barang_master/ubah/' + data[i].HASH_MD5_BARANG_MASTER + '" class="btn btn-info btn-xs block"><i class="fa fa-pencil"></i> Edit </a>' + ' ' +
