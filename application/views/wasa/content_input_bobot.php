<div id="page-wrapper" class="gray-bg">
		...
		<!-- MODAL LIHAT BOBOT -->
        <div class="modal inmodal fade" id="ModalLihatBobot" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
            <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<i class="fa fa-database modal-icon"></i>
				<h4 class="modal-title">Data Bobot Kriteria Penilaian</h4>
				<small class="font-bold">berdasarkan kode seleksi jabatan</small>
			</div>
				<div class="form-horizontal">
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Pendidikan (W1)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Lama Kerja (W2)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Sertifikasi (W3)</label>
							<div class="col-xs-9">
								<input name="BOBOT_PENILAIAN_SERTIFIKASI" id="BOBOT_PENILAIAN_SERTIFIKASI" class="form-control" type="text" placeholder="BOBOT_PENILAIAN_SERTIFIKASI" readonly>
							</div>
						</div>
						
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Wawancara (W4)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Ujian (W5)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Usia (W6)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Jenis Kelamin (W7)</label>
							<div class="col-xs-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Status Pernikahan (W8)</label>
							<div class="col-xs-9">
        ...
        <div class="modal inmodal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
				...
				<h4 class="modal-title">Input Bobot</h4>
				<small class="font-bold">berdasarkan kode seleksi jabatan</small>
			</div>
            <?php $attributes = array("id_input_bobot2" => "contact_form", "id" => "contact_form");
            echo form_open("input_bobot/update_data", $attributes);?>
				<div class="form-horizontal">
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Pendidikan (W1)</label>
							<div class="col-xs-9">
								<input class="add" name="PENILAIAN_PENDIDIKAN" type="range" min="1" max="50" value="20" class="slider" id="PENILAIAN_PENDIDIKAN">
								<p>Bobot (%): <span id="val_PENILAIAN_PENDIDIKAN"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Lama Kerja (W2)</label>
							<div class="col-xs-9">
								<input class="add" name="PENILAIAN_PENGALAMAN_KERJA" type="range" min="1" max="50" value="20" class="slider" id="PENILAIAN_PENGALAMAN_KERJA">
								<p>Bobot (%): <span id="val_PENILAIAN_PENGALAMAN_KERJA"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Sertifikasi (W3)</label>
							<div class="col-xs-9">
								<input class="add" name="PENILAIAN_SERTIFIKASI" type="range" min="1" max="50" value="10" class="slider" id="PENILAIAN_SERTIFIKASI">
								<p>Bobot (%): <span id="val_PENILAIAN_SERTIFIKASI"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Wawancara (W4)</label>
							<div class="col-xs-9">
								<input class="add" name="PENILAIAN_WAWANCARA" type="range" min="1" max="50" value="10" class="slider" id="PENILAIAN_WAWANCARA">
								<p>Bobot (%): <span id="val_PENILAIAN_WAWANCARA"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3">Bobot Penilaian Ujian (W5)</label>
							<div class="col-xs-9">
								<input class="add" name="PENILAIAN_UJIAN" type="range" min="1" max="50" value="10" class="slider" id="PENILAIAN_UJIAN">
								<p>Bobot (%): <span id="val_PENILAIAN_UJIAN"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								...
								<p>Bobot (%): <span id="val_PENILAIAN_USIA"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								...
								<p>Bobot (%): <span id="val_PENILAIAN_JENIS_KELAMIN"></span></p>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								...
								<p>Bobot (%): <span id="val_PENILAIAN_STATUS_PERNIKAHAN"></span></p>
							</div>
						</div>

												
						<div class="form-group">
							<label class="control-label col-xs-3">Jumlah Bobot:</label>
							<div class="col-xs-9">
   ...
   <!-- Mainly scripts -->
    ...
    <script>
        ...
        $(document).ready(function(){
			...
			tampil_data_input_bobot();	//pemanggilan fungsi tampil data.
			...
			$('#mydata').dataTable(
			{
                ...
                buttons: [
                    {extend: 'copy', title: 'input_bobot'},
                    {extend: 'csv', title: 'input_bobot'},
                    {extend: 'excel', title: 'input_bobot'},
                    {extend: 'pdf', title: 'input_bobot' },
			...
			//fungsi tampil data
			function tampil_data_input_bobot(){
				$.ajax({
					type  : 'ajax',
					url   : '<?php echo base_url()?>index.php/input_bobot/data_input_bobot',
					async : false,
					dataType : 'json',
					success : function(data){
						...
						for(i=0; i<data.length; i++){
							html += '<tr>'+
									...
									'<td>'+
										'<a href="javascript:;" class="btn btn-info btn-xs item_lihat" data="'+data[i].KODE_SJ+'"><i class="fa fa-search"></i> Lihat Pegawai </a>'+
									'</td>'+
									'<td>'+
										'<a href="javascript:;" class="btn btn-warning btn-xs item_lihat_bobot" data="'+data[i].KODE_SJ+'"><i class="fa fa-pencil"></i> Lihat Bobot </a>'+' '+
										'<a href="javascript:;" class="btn btn-info btn-xs item_edit" data="'+data[i].ID_SELEKSI_JABATAN+'"><i class="fa fa-plus"></i> Input Bobot</a>'+
									'</td>'+
			...
			$('#show_data').on('click','.item_lihat',function(){
				...
				$.ajax({
					type : "GET",
					url  : "<?php echo base_url('index.php/input_bobot/get_data_pegawai')?>",
					dataType : "JSON",
					data : {id:id},
					success : function(data){
						console.log(data);
			...
			$('#show_data').on('click','.item_lihat_bobot',function(){
				...
				$.ajax({
					type : "GET",
					url  : "<?php echo base_url('index.php/input_bobot/get_data_bobot')?>",
					dataType : "JSON",
					data : {id:id},
					success: function(data){
						$.each(data,function(ID_BOBOT, KODE_SJ, BOBOT_PENILAIAN_PENDIDIKAN, BOBOT_PENILAIAN_PENGALAMAN_KERJA, BOBOT_PENILAIAN_SERTIFIKASI, BOBOT_PENILAIAN_WAWANCARA, BOBOT_PENILAIAN_UJIAN, BOBOT_PENILAIAN_USIA, BOBOT_PENILAIAN_STATUS_PERNIKAHAN, BOBOT_PENILAIAN_JENIS_KELAMIN){
							$('#ModalLihatBobot').modal('show');
							...
							$('[name="BOBOT_PENILAIAN_SERTIFIKASI"]').val(data.BOBOT_PENILAIAN_SERTIFIKASI);
			...
			$('#show_data').on('click','.item_edit',function(){
				...
				$.ajax({
					type : "GET",
					url  : "<?php echo base_url('index.php/input_bobot/input_bobot')?>",
					dataType : "JSON",
					data : {id:id},
					success: function(data){
			...
			$('#btn_update').on('click',function(){
				...
				var BOBOT_PENILAIAN_SERTIFIKASI=$('#PENILAIAN_SERTIFIKASI').val();
				...
				$.ajax({
					url  : "<?php echo site_url('input_bobot/update_data')?>",
					type : "POST",
					dataType : "JSON",
					data : {KODE_SJ:KODE_SJ, BOBOT_PENILAIAN_PENDIDIKAN:BOBOT_PENILAIAN_PENDIDIKAN, BOBOT_PENILAIAN_PENGALAMAN_KERJA:BOBOT_PENILAIAN_PENGALAMAN_KERJA, BOBOT_PENILAIAN_SERTIFIKASI:BOBOT_PENILAIAN_SERTIFIKASI, BOBOT_PENILAIAN_WAWANCARA:BOBOT_PENILAIAN_WAWANCARA, BOBOT_PENILAIAN_UJIAN:BOBOT_PENILAIAN_UJIAN, BOBOT_PENILAIAN_USIA:BOBOT_PENILAIAN_USIA, BOBOT_PENILAIAN_STATUS_PERNIKAHAN:BOBOT_PENILAIAN_STATUS_PERNIKAHAN, BOBOT_PENILAIAN_JENIS_KELAMIN:BOBOT_PENILAIAN_JENIS_KELAMIN,  sum:sum },
					success: function(data){
						if (data == true)
						{
	...
	<script>
	var slider_PENILAIAN_SERTIFIKASI = document.getElementById("PENILAIAN_SERTIFIKASI");
	var output_PENILAIAN_SERTIFIKASI = document.getElementById("val_PENILAIAN_SERTIFIKASI");
	output_PENILAIAN_SERTIFIKASI.innerHTML = slider_PENILAIAN_SERTIFIKASI.value;

	slider_PENILAIAN_SERTIFIKASI.oninput = function() {
	  output_PENILAIAN_SERTIFIKASI.innerHTML = this.value;
	}
	</script>
