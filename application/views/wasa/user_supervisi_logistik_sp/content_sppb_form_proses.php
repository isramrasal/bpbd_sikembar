            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_SPV_LOG_SP6" id="CTT_SPV_LOG_SP6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_SVP_LOG_SP);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_SPV_LOG_SP6"]').val(data.CTT_SPV_LOG_SP);
        ...
        $('#btn_update_catatan_sppb').on('click', function() {
            ...
            var CTT_SPV_LOG_SP = $('#CTT_SPV_LOG_SP6').val();
            $.ajax({
