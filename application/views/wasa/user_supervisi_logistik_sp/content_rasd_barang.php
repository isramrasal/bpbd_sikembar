        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Data dari Barang Master</a><br>
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#ModalaAddTanpaBarangMaster"><span class="fa fa-plus"></span> Tambah Data Diluar Barang Master</a>
                </div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            ?>
                <div class="modal-header">
                    ...
                    <small class="font-bold">Silakan isi data RASD berdasarkan daftar Barang Master</small>
                </div>
                ...
                <div class="form-horizontal">
                    <div class="modal-body">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="<?php echo site_url('rasd_barang/simpan_data_dari_barang_master'); ?>" id="formTambah">
                                    ...
                                    <tbody id="show_data">
                                        ...
                                        foreach ($barang_master_list as $data) : ?>
                                            <tr>
                                                ...
                                                <td> <?php echo $data->ID_BARANG_MASTER; ?> </td>
            ...
            ?>
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Rasd Barang</h4>
                    <b class="font-bold">Maaf semua barang master sudah ada di rasd barang ini</b>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close"></i> Batal</button>
                </div>
...
<!-- MODAL ADD BUKAN DARI BARANG MASTER -->
<div class="modal inmodal fade" id="ModalaAddTanpaBarangMaster" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <i class="fa fa-suitcase modal-icon"></i>
                <h4 class="modal-title">Rasd Barang</h4>
                <small class="font-bold">Silakan isi data Rasd Barang</small>
            </div>
            <?php $attributes = array("NAMA_JENIS_BARANG" => "contact_form", "id" => "contact_form");
            echo form_open("RASD_barang/simpan_data", $attributes); ?>
            <div class="form-horizontal">
                <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Rasd Barang</h4>
                <small class="font-bold">Silakan edit data rasd barang</small>
            </div>
            <?php $attributes = array("id_RASD_barang2" => "contact_form", "id" => "contact_form");
            echo form_open("RASD_barang/update_data", $attributes); ?>
            <div class="form-horizontal">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3">ID Rasd Barang</label>
                        <div class="col-xs-9">
                            <input name="ID_RASD_BARANG2" id="ID_RASD_BARANG2" class="form-control" type="text" placeholder="ID rasd barang" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="ID_BARANG_MASTER2" id="ID_BARANG_MASTER2" class="form-control" placeholder="Barang belum ada di barang master" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="NAMA2" id="NAMA2" class="form-control" type="text" placeholder="Belum terdata di barang master" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="MEREK2" id="MEREK2" class="form-control" type="text" placeholder="Belum terdata di barang master" readonly>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Hapus Data rasd barang</h4>
            </div>
...
<script>
    ...
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + jumlah_barang + '</td>' +
                            '<td>' +
                            '<a href="javascript:;" class="btn btn-info btn-xs item_edit" data="' + data[i].ID_RASD_BARANG + '"><i class="fa fa-pencil"></i> Edit </a>' + ' ' +
                            '<a href="javascript:;" class="btn btn-danger btn-xs item_hapus" data="' + data[i].ID_RASD_BARANG + '"><i class="fa fa-trash"></i> Hapus</a>' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
        ...
        $('#show_data').on('click', '.item_edit', function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('RASD_barang/get_data') ?>",
                dataType: "JSON",
                data: {
                    id: id
                },
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="ID_RASD_BARANG2"]').val(data.ID_RASD_BARANG);
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        if (data.ID_BARANG_MASTER != null) {
                            $('#NAMA_3').html('Rasd Barang : ' + data.NAMA);
                        } else {
                            $('#NAMA_3').html('Rasd Barang : ' + data.NAMA_RASD_BARANG);
                        }
                    });
                }
            });
        ...
        $('#btn_simpan').click(function() {
            ...
            $.ajax({
                url: "<?php echo site_url('RASD_barang/simpan_data'); ?>",
                type: 'POST',
                data: form_data,
                success: function(data) {
                    console.log(data);
        ...
        $('#btn_update').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo site_url('RASD_barang/update_data') ?>",
                type: "POST",
                dataType: "JSON",
                data: {
        ...
        $('#btn_hapus').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('RASD_barang/hapus_data') ?>",
                dataType: "JSON",
                data: {
                    kode: kode
                },
