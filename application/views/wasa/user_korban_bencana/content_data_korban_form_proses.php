                                ...
                                if (isset($Korban)) {
                                    foreach ($Korban as $Korban):
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Nama Korban</label>
                                            <div class="col-sm-10">
                                                    <input name="NAMA_KORBAN_GANTI" id="NAMA_KORBAN_GANTI" type="text" class="form-control"
                                                    value="<?php echo $Korban->NAMA_KORBAN; ?>">
                                                    <input name="NAMA_KORBAN_GANTI_ASLI" id="NAMA_KORBAN_GANTI_ASLI" type="hidden" class="form-control" value="<?php echo $Korban->NAMA_KORBAN; ?>">
                                            </div>
                                        </div>

                                        <div class="form-group" id="data_TANGGAL_LAHIR"><label class="col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <?php
                                                if (empty($Korban->TANGGAL_LAHIR)) {
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_LAHIR" name="TANGGAL_LAHIR" type="text" class="form-control" placeholder="dd/mm/yyyy">
                                                    </div>
                                                <?php
                                                } else {
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_LAHIR" name="TANGGAL_LAHIR" type="text" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $Korban->TANGGAL_LAHIR; ?>">
                                                    </div>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">NIK</label>
                                            <div class="col-sm-10"><input name="NIK" id="NIK" type="text"
                                                    class="form-control" value="<?php echo $Korban->NIK; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="data_TANGGAL_KEJADIAN_BENCANA"><label class="col-sm-2 control-label">Tanggal Kejadian Bencana</label>
                                            <div class="col-sm-10">
                                                ...
                                                ?>
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="TANGGAL_KEJADIAN_BENCANA" name="TANGGAL_KEJADIAN_BENCANA" type="text" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $Korban->TANGGAL_KEJADIAN_BENCANA; ?>">
                                                    </div>
                                                <?php
                                                }
                                                ?>
