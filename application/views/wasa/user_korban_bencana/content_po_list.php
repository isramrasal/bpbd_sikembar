            ...
            if (ID_PROYEK == "Semua") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        if (data_2 == 'TIDAK ADA DATA') {
                                            ...
                                            for (j = 0; j < data_2.length; j++) {
                                                var TANGGAL = '';
                                                TANGGAL = '<a href="#" class="btn btn-link btn-xs text-decoration-none"> ' + data_2[j].JENIS_PENGADAAN + ' </a>';
                                                html += TANGGAL + "</br>";
                                            }
                                            html +=
                                        '</td>';
                        ...
                        html_head = '<tr><th>No. PO</th><th>Proyek</th><th>Pekerjaan</th><th>Tanggal Dokumen PO</th><th>Jenis Pengadaan</th><th>Status PO</th></tr>';
                        $('#show_data_head').html(html_head);
                        $('#show_data').html(html);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        html_head = '<tr><th>No. PO</th><th>Pekerjaan</th><th>Tanggal Dokumen PO</th><th>Jenis Pengadaan</th><th>Status PO</th></tr>';
                        $('#show_data_head').html(html_head);
                        $('#show_data').html(html);
