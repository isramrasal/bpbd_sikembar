                    ...
                    <div class="chat-activity-list">
                        ...
                        <div class="chat-element">
                            ...
                            <div class="media-body ">
                                ...
                                <p class="m-b-xs">
                                    Chat utama di sebelah kiri. User peng-create
                                </p>
                        ...
                        <div class="chat-element right">
                            ...
                            <div class="media-body text-right ">
                                ...
                                <p class="m-b-xs">
                                    dibales user lain ada di sebelah kanan
                                </p>
                                <small class="text-muted">Today 4:21 pm - 12.06.2014</small>
                            </div>
                        </div>
                        <div class="chat-element right">
                            ...
                            <div class="media-body text-right ">
                                ...
                                <strong>John Smith</strong>
                                <p class="m-b-xs">
                                    yang ini juga balesan di sebelah kanan
                                </p>
                                <small class="text-muted">Today 4:21 pm - 12.06.2014</small>
                            </div>
                        </div>
                ...
                <div class="chat-form">
                    <form role="form">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-sm btn-primary m-t-n-xs"><strong>Kirim Pesan</strong></button>
                        </div>
                    </form>
                </div>
            </div>
