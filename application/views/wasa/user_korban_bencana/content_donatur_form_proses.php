...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('index.php/Donatur/') ?>">Donatur</a>
            </li>
            <li class="active">
                <strong>
                    <a>Form Donatur</a>
                            ...
                            <form method="get" class="form-horizontal">
                                ...
                                if (isset($Donatur)) {
                                    foreach ($Donatur->result() as $Donatur):
                                        ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Tanggal Surat</label>
                                    <div class="col-sm-10">
                                        <input name="Tanggal_Surat" id="Tanggal_Surat" type="text" class="form-control"
                                            value="<?php echo $Donatur->TANGGAL_SURAT ?>">
                                        <input name="Tanggal_Surat" id="Tanggal_Surat" type="hidden"
                                            class="form-control" value="<?php echo $Donatur->TANGGAL_SURAT; ?>">
                                    </div>
                                </div>

                                <div class="form-group" id="data_TANGGAL_DOKUMEN_PENGAJUAN"><label
                                        class="col-sm-2 control-label">Tanggal Pembuatan</label>
                                    <div class="col-sm-10">
                                        <?php
                                                if (empty($Donatur->TANGGAL_PEMBUATAN)) {
                                                ?>
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                id="TANGGAL_DOKUMEN_Donatur" name="TANGGAL_DOKUMEN_PENGAJUAN"
                                        ...
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                ...
                                                type="text" class="form-control" placeholder="dd/mm/yyyy"
                                                value="<?php echo $Donatur->TANGGAL_PEMBUATAN; ?>">
                                        </div>
                                        <?php
                                                }
                                                ?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Donatur</label>
                                    <div class="col-sm-10"><input name="Nama_Donatur" id="Nama_Donatur" type="text"
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <div class="sm-10">
                            <a href="<?php echo base_url('index.php/Donatur_form/view/'); ?><?php echo $CODE_MD5; ?>"
                                class="btn btn-primary"><span class="fa fa-save"></span> Simpan Perubahan & View Dokumen
                                Pengajuan Bantuan</a>
                            </br>
                            <a href="javascript" id="item_edit_kirim_donatur" name="item_edit_kirim_donatur"
                                class="btn btn-success" data="<?php echo $ID_FORM_PENGADAAN_BARANG ; ?>"><span
...
$(document).ready(function() {
    let ID_FORM_PENGADAAN_BARANG = <?php echo $ID_FORM_PENGADAAN_BARANG  ?>;
    let CODE_MD5 = "<?php echo $CODE_MD5 ?>";
    let Nomor_Surat_Pengadaan_Barang = "<?php echo $CODE_MD5 ?>";
    ...
    $('#mydata').dataTable({
        ...
        buttons: [{
                extend: 'excel',
                title: 'bantuan barang export EXCEL',
                exportOptions: {
    ...
    function tampil_data_pengajuan_form() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                ID_FORM_PENGADAAN_BARANG: ID_FORM_PENGADAAN_BARANG
            },
    ...
    item_edit_kirim_donatur.onclick = function() {
