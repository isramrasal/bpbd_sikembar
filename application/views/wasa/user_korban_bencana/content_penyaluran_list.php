            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" value="" name="NOMOR_KK_PENERIMA" id="NOMOR_KK_PENERIMA"
                                placeholder="Contoh: 3602041211870001" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" value="" name="INSTANSI_PENERIMA" id="INSTANSI_PENERIMA"
        ...
        if (ID_JENIS_BENCANA_LIST == "Semua") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html_head = '<tr><th>No. Penyaluran</th><th>Jenis Bencana</th><th>Nama Penerima</th><th>NIK Penerima</th><th>Instansi Penerima</th><th>Desa Penerima</th><th>Kecamatan Penerima</th><th>Tanggal Kejadian Bencana</th><th>Aksi</th></tr>';
                    $('#show_data_head').html(html_head);
                    $('#show_data').html(html);
