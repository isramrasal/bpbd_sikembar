                        ...
                        <div class="panel-body">
                            <form method="get" class="form-horizontal">
                                ...
                                ?>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Tanggal Pengajuan SPPB:</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $SPPB->TANGGAL_DOKUMEN_SPPB; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Tanggal Aktual Pembuatan SPPB:</label>
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="<?php echo site_url('SPPB_form/simpan_data_dari_fpb_form'); ?>" id="formTambahFPB">
                                <table class="table table-striped table-bordered table-hover" id="modalfpb">
                                    <thead>
                                        <tr>
                                            <th>Pilih<input type="checkbox" id="checkAllfpb"></th>
                                            <th>Kode Barang</th>
                                            <th>No Urut FPB</th>
                                            <th>Nama Barang</th>
                                            <th>Merek Barang</th>
                                    ...
                                    <tbody">
                                        ...
                                        foreach ($fpb_barang_list as $data) : ?>
                                            <tr>
                                                ...
                                                <td style="width: 20%;"> <?php echo $data->JUMLAH_QTY_SPPB ?> </td>
                                            </tr>
                                        <?php endforeach;
                                        ?>
                                        </tbody>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="TANGGAL_MULAI_PAKAI_HARI_4" id="TANGGAL_MULAI_PAKAI_HARI_4" class="form-control" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="TANGGAL_SELESAI_PAKAI_HARI_4" id="TANGGAL_SELESAI_PAKAI_HARI_4" class="form-control" type="date">
                        </div>
                    </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_STAFF_UMUM_LOG_SP6" id="CTT_STAFF_UMUM_LOG_SP6" required></textarea>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_STAFF_UMUM_LOG_SP);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_STAFF_UMUM_LOG_SP6"]').val(data.CTT_STAFF_UMUM_LOG_SP);
        ...
        $('#btn_simpan_data_di_luar_barang_master').click(function() {
            var form_data = {
                ...
                TANGGAL_MULAI_PAKAI_HARI: $('#TANGGAL_MULAI_PAKAI_HARI_4').val(),
                TANGGAL_SELESAI_PAKAI_HARI: $('#TANGGAL_SELESAI_PAKAI_HARI_4').val()
            };
            $.ajax({
        ...
        $('#btn_update').on('click', function() {
            ...
            var PERALATAN_PERLENGKAPAN = $('#PERALATAN_PERLENGKAPAN2').val();
        ...
        $('#btn_update_catatan_sppb').on('click', function() {
            ...
            var ID_SPPB = $('#ID_SPPB6').val();
            var CTT_STAFF_UMUM_LOG_SP = $('#CTT_STAFF_UMUM_LOG_SP6').val();
            $.ajax({
