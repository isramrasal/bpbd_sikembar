                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <select name="SUMBER_PENERIMAAN" class="form-control" id="SUMBER_PENERIMAAN">
                                ...
                                <option value="Pengiriman Dari Kantor Pusat">Pengiriman Dari Kantor Pusat</option>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].PROGRESS_FSTB == "Dalam Proses Pembuatan Staff Umum Logistik SP") {
                            html_progress = '<a href="#" class="btn btn-info btn-xs block"> ' + data[i].PROGRESS_FSTB + ' </a>';
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-warning btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a>';
                        } else if (data[i].PROGRESS_FSTB == "Dalam Proses Staff Logistik SP") {
                            html_progress = '<a href="#" class="btn btn-info btn-xs block"> ' + data[i].PROGRESS_FSTB + ' </a>';
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-warning btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a>';
                            ...
                            tombol_fstb = '<a href="<?php echo base_url() ?>FSTB_form/view/' + data[i].HASH_MD5_FSTB + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i> Lihat FSTB </a>';
                        } else {
        ...
        $("#SUMBER_PENERIMAAN").change(function() {
            if ($("#SUMBER_PENERIMAAN option:selected").text() == 'Pengiriman Dari Kantor Pusat') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<option value=1> Kantor Pusat </option>';
                        }
