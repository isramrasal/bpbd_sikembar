...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="javascript:;" class="btn btn-primary btn-xs item_gambar block" data="' + data[i].ID_FPB_FORM + '"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i>Upload Surat Jalan</a>' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
        ...
        $('#btn_update_catatan_surat_jalan').on('click', function() {
            ...
            let CTT_STAFF_UMUM_LOG_SP = $('#CTT_STAFF_UMUM_LOG_SP6').val();
            $.ajax({
