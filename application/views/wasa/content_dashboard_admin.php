			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content text-center p-md">
						...
						<h2><span class="text-navy">WME - Employment System</span>
						adalah sistem informasi kepegawaian <br/> PT. Wasa Mitra Engineering</h2>
					</div>
				</div>
			</div>	
			...
			<div class="row">
						<div class="col-lg-3">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<h1 class="no-margins"><?php echo $jumlah_pegawai; ?></h1>
									<div class="stat-percent font-bold text-success">100% <i class="fa fa-group"></i></div>
									<small>Pegawai Tetap dan PKWT</small>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<h1 class="no-margins"><?php echo $jumlah_pegawai_tetap; ?></h1>
									<div class="stat-percent font-bold text-info">100% <i class="fa fa-user-circle"></i></div>
						...
						<div class="col-lg-3">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<h1 class="no-margins"><?php echo $jumlah_pegawai_pkwt; ?></h1>
									<div class="stat-percent font-bold text-navy">100% <i class="fa fa-user-circle-o"></i></div>
									<small>Pegawai PKWT</small>
								</div>
							</div>
						</div>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo base_url(); ?>assets/wasa/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
