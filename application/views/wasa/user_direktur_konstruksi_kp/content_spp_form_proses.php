                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            ...
                                            <?php echo $CATATAN_SPP['CTT_M_PROC_KP']; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            ...
                                            <?php echo $CATATAN_SPP['CTT_D_KONS']; ?>
                                        </div>
                                    </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Harga Satuan Barang</label>
                        <div class="col-xs-9">
                            <input name="HARGA_SATUAN_BARANG_FIX5" id="HARGA_SATUAN_BARANG_FIX5" class="form-control touchspin1" type="number" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Harga Total Barang</label>
                        <div class="col-xs-9">
                            <input name="HARGA_TOTAL_FIX5" id="HARGA_TOTAL_FIX5" class="form-control touchspin1" type="number" readonly>
                        </div>
                    </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_D_KONS6" id="CTT_D_KONS6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // function tampil_data_spp_penyerahan_vendor_top() {
        //     var ID_SPP = ID_SPP;
        //     $.ajax({
        //         type: "GET",
        //         url: "<?php echo base_url('SPP_form/get_data_spp') ?>",
        //         dataType: "JSON",
        //         data: {
        //             ID_SPP: ID_SPP
        //         },
        ...
        $('#btn_update_keterangan_barang').on('click', function() {
            ...
            let ID_SPP_FORM = $('#ID_SPP_FORM5').val();
        ...
        $('#btn_update_catatan_spp').on('click', function() {
            ...
            let CTT_D_KONS = $('#CTT_D_KONS6').val();
            $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_D_KONS6"]').val(data.CTT_D_KONS);
