            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_D_EP_KONS6" id="CTT_D_EP_KONS6"  required></textarea>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_D_EP_KONS6"]').val(data.CTT_D_EP_KONS);
        ...
        let CTT_D_EP_KONS = $('#CTT_D_EP_KONS6').val();
        $.ajax({
