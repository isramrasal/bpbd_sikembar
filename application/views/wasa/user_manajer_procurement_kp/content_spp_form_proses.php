            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_M_PROC_KP6" id="CTT_M_PROC_KP6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="KETERANGAN5"]').val(data.KETERANGAN_M_PROC_KP);
        ...
        $('#btn_update_catatan_spp').on('click', function() {
            ...
            let CTT_M_PROC_KP = $('#CTT_M_PROC_KP6').val();
            $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_M_PROC_KP6"]').val(data.CTT_M_PROC_KP);
