...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_PO == "Dalam Proses Pembuatan Manajer Procurement KP") { ?>
            ...
            <?php
            } else if ($PROGRESS_PO == "Dalam Proses Manajer Procurement KP") { ?>
                <a href="<?php echo base_url('index.php/PO_form/index/') ?><?php echo $HASH_MD5_PO; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Ubah PO</a>
                <a href="javascript:;" id="item_edit_kirim_po" name="item_edit_kirim_po" class="btn btn-success" data="<?php echo $ID_PO; ?>"><span class="fa fa-send"></span> Ajukan PO Untuk Proses Selanjutnya </a>
            <?php
            } else {
...
<script>
    ...
    $(document).ready(function() {
        ...
        item_edit_kirim_po.onclick = function() {
            var PROGRESS_PO = "<?php echo $PROGRESS_PO  ?>";
            if (PROGRESS_PO == "Dalam Proses Manajer Procurement KP") {
        ...
        item_edit_kirim_email_po.onclick = function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.ID_VENDOR == null || data.ID_TERM_OF_PAYMENT == null || data.ID_PROYEK_LOKASI_PENYERAHAN == null || data.PROGRESS_PO == "Dalam Proses Staff Procurement KP") {
                        console.log(data);
