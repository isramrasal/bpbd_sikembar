                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php foreach ($dokumen as $quotation_form_file) {
                                            if ($quotation_form_file->JENIS_FILE == "Dokumen List Harga" || $quotation_form_file->JENIS_FILE == "Dokumen Lainnya - Vendor") { ?>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <input name="ID_QUOTATION_FORM5" id="ID_QUOTATION_FORM5" class="form-control" type="hidden" readonly>
