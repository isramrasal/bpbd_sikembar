        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <br>
                    <a href="#" class="btn btn-success " data-toggle="modal" data-target="#ModalAddRABP"><span class="fa fa-plus"></span> Tambah Data</a><br>
    ...
    <div class="modal-dialog" style="width: 70vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <i class="fa fa-btc  modal-icon"></i>
                <h4 class="modal-title">RAB Proyek</h4>
                <small class="font-bold">Silakan tambah data nama kategori dan anggaran biaya</small>
            </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Jenis Rencana Anggaran</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="JENIS_RASD_5" id="JENIS_RASD_5">
                                <option value=''>- Pilih Jenis -</option>
                                <option value='RASD'>Menggunakan RASD (Nominal Rencana Anggaran Berdasarkan RASD)</option>
                                <option value='TANPA_RASD'>Tanpa RASD (Nominal Rencana Input Manual dan Lumpsum Final)</option>
                            </select>

                        </div>
                    </div>

                    <div id="show_hidden_TANPA_RASD" hidden>
                        <div class="form-group">
                            <label class="control-label col-xs-3">Rencana Anggaran</label>
                            <div class="col-xs-9">
                                <input name="RENCANA_ANGGARAN_5" id="RENCANA_ANGGARAN_5" class="form-control" type="number" placeholder="Contoh: 12000000000">
                            </div>
                        </div>
                    </div>

                    <div id="show_hidden_RASD" hidden>
                        <div class="form-group">
                            <label class="control-label col-xs-3">Nama RASD</label>
                            <div class="col-xs-9">
                                <input name="NAMA_RASD_5" id="NAMA_RASD_5" class="form-control" type="text" placeholder="Contoh: Main Work">
                            </div>
                        </div>
                    </div>
...
<!-- MODAL ADD RABP-->
<div class="modal inmodal fade" id="ModalAddRASD" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog" style="width: 70vw;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <small class="font-bold">Silakan tambah data nama RASD</small>
            </div>
            <?php $attributes = array("nama_rasd" => "nama_Sub nama_rabp", "id" => "id");
            echo form_open("RAB_form/simpan_data_rasd", $attributes); ?>
            <div class="form-horizontal">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3">Nama Kategori RAB</label>
                        <div class="col-xs-9">
                            <input name="NAMA_KATEGORI_4" id="NAMA_KATEGORI_4" class="form-control" type="text" disabled>
                            <input name="ID_PROYEK_4" id="ID_PROYEK_4" class="form-control" type="text">
                            <input name="ID_PROYEK_SUB_PEKERJAAN_4" id="ID_PROYEK_SUB_PEKERJAAN_4" class="form-control" type="text">
                            <input name="ID_RAB_FORM_4" id="ID_RAB_FORM_4" class="form-control" type="text">
                            <input name="ID_RAB_4" id="ID_RAB_4" class="form-control" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Nama RASD</label>
                        <div class="col-xs-9">
                            <input name="NAMA_RASD_4" id="NAMA_RASD_4" class="form-control" type="text" placeholder="Contoh: Main Work">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close"></i> Batal</button>
                    <button class="btn btn-primary" id="btn_simpan_rasd"><i class="fa fa-save"></i> Simpan</button>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Jenis Rencana Anggaran</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="JENIS_RASD_2" id="JENIS_RASD_2">
                                <option value=''>- Pilih Jenis -</option>
                                <option value='RASD'>Menggunakan RASD (Nominal Rencana Anggaran Berdasarkan RASD)</option>
                                <option value='TANPA_RASD'>Tanpa RASD (Nominal Rencana Input Manual dan Lumpsum Final)</option>
                            </select>
                    ...
                    <div id="show_hidden_TANPA_RASD_2" hidden>
                        <div class="form-group">
                            <label class="control-label col-xs-3">Rencana Anggaran</label>
                            <div class="col-xs-9">
                                <input name="RENCANA_ANGGARAN_2" id="RENCANA_ANGGARAN_2" class="form-control" type="number" placeholder="Contoh: 12000000000">
                            </div>
                        </div>
                    </div>

                    <div id="show_hidden_RASD_2" hidden>
                        <div class="form-group">
                            <label class="control-label col-xs-3">Nama RASD</label>
                            <div class="col-xs-9">
                                <input name="NAMA_RASD_2" id="NAMA_RASD_2" class="form-control" type="text" placeholder="Contoh: Main Work">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#JENIS_RASD_5").change(function() {
            if ($("#JENIS_RASD_5 option:selected").val() == 'RASD') {
                $('#show_hidden_RASD').attr("hidden", false); //enable input
                $('#show_hidden_TANPA_RASD').attr("hidden", true); //disable input
            } else if ($("#JENIS_RASD_5 option:selected").val() == 'TANPA_RASD') {
                $('#show_hidden_RASD').attr("hidden", true); //enable input
                $('#show_hidden_TANPA_RASD').attr("hidden", false); //enadisableble input
            } else {
                $('#show_hidden_RASD').attr("hidden", true); //disable input
                $('#show_hidden_TANPA_RASD').attr("hidden", true); //disable input

                $('#NAMA_RASD_5').val("");
                $('#NAMA_RASD_TEMP_5').val("");
                $('#RENCANA_ANGGARAN_5').val("");
            }
        });

        $("#JENIS_RASD_2").change(function() {
            if ($("#JENIS_RASD_2 option:selected").val() == 'RASD') {
                $('#show_hidden_RASD_2').attr("hidden", false); //enable input
                $('#show_hidden_TANPA_RASD_2').attr("hidden", true); //disable input
            } else if ($("#JENIS_RASD_2 option:selected").val() == 'TANPA_RASD') {
                $('#show_hidden_RASD_2').attr("hidden", true); //enable input
                $('#show_hidden_TANPA_RASD_2').attr("hidden", false); //enadisableble input
            } else {
                $('#show_hidden_RASD_2').attr("hidden", true); //disable input
                $('#show_hidden_TANPA_RASD_2').attr("hidden", true); //disable input
            }
        });
        ...
        function tampil_data_RAB_form() {
            var RENCANA_ANGGARAN = "";
            var REALISASI_ANGGARAN = "";
            var SISA_ANGGARAN = "";
            var TOTAL_RENCANA_ANGGARAN = "";
            var TOTAL_REALISASI_ANGGARAN = "";
            var TOTAL_SISA_ANGGARAN = "";
            $.ajax({
                type: 'GET',
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        $.ajax({
                            ...
                            async: false,
                            data: {
                                ID_RAB_FORM: data_1[i].ID_RAB_FORM,
                            },
                            success: function(data) {
                                var data_2 = data;
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        if (data_1[i].JENIS_RASD == "TANPA_RASD") {
                                            html_keterangan_RASD = "</br></br> (Input Manual)";

                                            RENCANA_ANGGARAN = new Intl.NumberFormat('id-ID', {
                                                style: 'currency',
                                                currency: 'IDR'
                                            }).format(data_1[i].RENCANA_ANGGARAN);

                                            REALISASI_ANGGARAN = new Intl.NumberFormat('id-ID', {
                                                style: 'currency',
                                                currency: 'IDR'
                                            }).format(data_1[i].REALISASI_ANGGARAN);

                                            SISA_ANGGARAN = new Intl.NumberFormat('id-ID', {
                                                style: 'currency',
                                                currency: 'IDR'
                                            }).format(data_1[i].RENCANA_ANGGARAN - data_1[i].REALISASI_ANGGARAN);
                                            ...
                                            SISA_ANGGARAN = new Intl.NumberFormat('id-ID', {
                                                style: 'currency',
                                                currency: 'IDR'
                                            }).format(RENCANA_ANGGARAN_NUMERIC - 0);
                                        ...
                                        html += '<tr>' +
                                            ...
                                            '<td>' + SISA_ANGGARAN + "</br>" + (data_1[i].RENCANA_ANGGARAN / data_1[i].REALISASI_ANGGARAN) + '</td>' +
                                            '<td>';
                                        ...
                                        if (data_2 == 'TIDAK ADA DATA') {
                                            ...
                                            for (j = 0; j < data_2.length; j++) {
                                                var nama_rasd = '';
                                                nama_rasd = '<a href="<?php echo base_url() ?>rasd_form/index/' + data_2[j].HASH_MD5_RASD + '" class="btn btn-info btn-xs block"><i class="fa fa-pencil"></i> Edit RASD ' + data_2[j].NAMA_RASD + ' </a>' + ' ';
                                                html += nama_rasd;
                                            }

                                        }

                                        html += '<a href="javascript:;" class="btn btn-success btn-xs item_tambah_rasd block" data="' + data_1[i].ID_RAB_FORM + '"><i class="fa fa-plus"></i> Tambah RASD </a>' + '<a href="javascript:;" class="btn btn-warning btn-xs item_edit block" data="' + data_1[i].ID_RAB_FORM + '"><i class="fa fa-pencil"></i> Edit RAB </a>' + ' ' +
                                            '<a href="javascript:;" class="btn btn-danger btn-xs item_hapus block" data="' + data_1[i].ID_RAB_FORM + '"><i class="fa fa-trash"></i> Hapus RAB </a>' +
                                            '</td>' +
                                            '</tr>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="JENIS_RASD_2"]').val(data.JENIS_RASD);
        ...
        $('#btn_simpan_rab').click(function() {
            ...
            if ($("#JENIS_RASD_5 option:selected").val() == 'RASD') {
                var form_data = {
                    ...
                    NAMA_RASD: $('#NAMA_RASD_5').val(),
                    JENIS_RASD: $('#JENIS_RASD_5').val(),
                };

            }

            if ($("#JENIS_RASD_5 option:selected").val() == 'TANPA_RASD') {
                ...
                var form_data = {
                    ...
                    ID_PROYEK_SUB_PEKERJAAN: $('#ID_PROYEK_SUB_PEKERJAAN_5').val(),
                    NAMA_KATEGORI: $('#NAMA_KATEGORI_5').val(),
                    RENCANA_ANGGARAN: $('#RENCANA_ANGGARAN_5').val(),
                    JENIS_RASD: $('#JENIS_RASD_5').val(),
                };
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data != '') {
                        ...
                        $('[name="RENCANA_ANGGARAN_5"]').val("");
                        $('[name="NAMA_RASD_5"]').val("");
                        $('[name="JENIS_RASD_5"]').val("");
                        $('[name="NAMA_RASD_TEMP_5"]').val("");
        ...
        //SIMPAN DATA RASD
        $('#btn_simpan_rasd').click(function() {
            var form_data = {
                ID_PROYEK: $('#ID_PROYEK_4').val(),
                ID_PROYEK_SUB_PEKERJAAN: $('#ID_PROYEK_SUB_PEKERJAAN_4').val(),
                ID_RAB: $('#ID_RAB_4').val(),
                ID_RAB_FORM: $('#ID_RAB_FORM_4').val(),
                NAMA_RASD: $('#NAMA_RASD_4').val()
            };

            $.ajax({
                url: "<?php echo site_url('RAB_form/simpan_data_rasd'); ?>",
                type: 'POST',
                data: form_data,
                success: function(data) {
                    if (data != '') {
                        ...
                        $('[name="ID_PROYEK_4"]').val("");
                        $('[name="ID_PROYEK_SUB_PEKERJAAN_4"]').val("");
                        $('[name="ID_RAB_4"]').val("");
                        $('[name="ID_RAB_FORM_4"]').val("");
                        $('[name="NAMA_KATEGORI_4"]').val("");
                        $('[name="NAMA_RASD_4"]').val("");
                        $('#ModalAddRASD').modal('hide');
                        window.location.reload();
                    }
                }
            });
        ...
        $('#btn_update').on('click', function() {
            ...
            if ($("#JENIS_RASD_2 option:selected").val() == 'TANPA_RASD') {
                ...
                var form_data = {
                    ...
                    ID_RAB_FORM: $('#ID_RAB_FORM_2').val(),
                    NAMA_KATEGORI: $('#NAMA_KATEGORI_2').val(),
                    RENCANA_ANGGARAN: $('#RENCANA_ANGGARAN_2').val(),
                    JENIS_RASD: $('#JENIS_RASD_2').val(),
                };
            }
        ...
        $('#show_data_RAB').on('click', '.item_tambah_rasd', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('[name="NAMA_KATEGORI_4"]').val(data.NAMA_KATEGORI);
                    $('[name="ID_RAB_FORM_4"]').val(data.ID_RAB_FORM);
                    $('[name="ID_RAB_4"]').val(data.ID_RAB);
                    $('[name="ID_PROYEK_SUB_PEKERJAAN_4"]').val(data.ID_PROYEK_SUB_PEKERJAAN);
                    $('[name="ID_PROYEK_4"]').val(data.ID_PROYEK);
                    $('#ModalAddRASD').modal('show');
                }
            });
            return false;
        });
