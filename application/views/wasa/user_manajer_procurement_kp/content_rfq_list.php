        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">Tanggal Pengajuan RFQ</label>
                        <div class="col-xs-9">
                            <input id="TANGGAL_DOKUMEN_RFQ" type="date" class="form-control">
...
<script>
    $(document).ready(function() {
        ...
        document.querySelector("#TANGGAL_DOKUMEN_RFQ").valueAsDate = new Date();
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                html += '<tr>' +
                                    ...
                                    '<td>' + '<a href="#" class="btn btn-link btn-xs text-decoration-none"> ' + data_1[i].TANGGAL_DOKUMEN_SPPB + ' </a>' + '</td>' +
                                ...
                                if (data_2 == 'TIDAK ADA DATA') {
                                    ...
                                    for (j = 0; j < data_2.length; j++) {
                                        var html_progress = '';
                                        if (data_2[j].PROGRESS_RFQ == "Dalam Proses Manajer Procurement KP") {
                                            html_progress = '<a href="#" class="btn btn-warning btn-xs"> ' + data_2[j].PROGRESS_RFQ + ' </a>';
                                        } else if (data_2[j].PROGRESS_RFQ == "Dalam Proses Pembuatan Manajer Procurement KP") {
                                            html_progress = '<a href="#" class="btn btn-warning btn-xs"> ' + data_2[j].PROGRESS_RFQ + ' </a>';
                                        } else {
        ...
        $('#btn_simpan').click(function() {
            var form_data = {
                ...
                TANGGAL_DOKUMEN_RFQ: $('#TANGGAL_DOKUMEN_RFQ').val()
            };
            $.ajax({
