...
<!-- MODAL ADD SUB PEKERJAAN-->
<div class="modal inmodal fade" id="ModalAddSubPekerjaan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content animated bounceInRight">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<i class="fa fa-subscript modal-icon"></i>
				<h4 class="modal-title">Jenis Pekerjaan</h4>
				<small class="font-bold">Silakan tambah data Jenis Pekerjaan</small>
			</div>
			<?php $attributes = array("nama_Sub Pekerjaan" => "nama_Sub Pekerjaan", "id" => "id");
			echo form_open("Proyek/simpan_data_sub_pekerjaan", $attributes); ?>
			<div class="form-horizontal">
				<div class="modal-body">

					<div class="form-group">
						<label class="control-label col-xs-3">Nama Jenis Pekerjaan</label>
						<div class="col-xs-9">
		...
		<div class="modal-content">
			...
			<form class="form-horizontal">
				<div class="modal-body">
					...
					<div class="alert alert-warning">
						<p>Apakah Anda yakin ingin menghapus data ini? Data sub pekerjaan yang sudah dihapus tidak bisa dipulihkan kembali.</p>
						</br>
				...
				success: function(data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							'<td>' + '<a href="<?php echo base_url() ?>rab_form/index/' + data_1[i].HASH_MD5_RAB + '" class="btn btn-primary btn-xs block"><i class="fa fa-search"></i> Lihat RAB '+ data_1[i].NAMA_SUB_PEKERJAAN+' </a>' +  ' ' +
			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function() {
						...
						$('#NAMA_SUB_PEKERJAAN_3').html('Sub Pekerjaan: ' + data.NAMA_SUB_PEKERJAAN);
					});
				}
			});
		});
