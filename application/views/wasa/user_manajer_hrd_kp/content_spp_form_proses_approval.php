                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            ...
                                            <?php echo $CATATAN_SPP['CTT_STAFF_PROC_SP']; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            ...
                                            <?php echo $CATATAN_SPP['CTT_SPV_PROC_SP']; ?>
                                        </div>
                                    </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_M_KEU6" id="CTT_M_KEU6" required></textarea>
                        </div>
                    </div>
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].CORET == '1') {
                            ...
                            html += '<tr>' +
                                ...
                                '<td>' +
                                '<a href="javascript:;" class="btn btn-info btn-xs item_batal_coret block" data="' + data[i].ID_SPP_FORM + '"><i class="fa fa-check"></i> Batal Tolak</a>' + ' ' + data[i].CATATAN_BATAL_CORET +
                                '</td>' +
                                '<td>' +
                                '<a href="javascript:;" class="btn btn-success btn-xs item_edit_keterangan block" data="' + data[i].ID_SPP_FORM + '"><i class="fa fa-comment  "></i> Keterangan </a>' + ' ' +
                                '</td>' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="CTT_M_KEU6"]').val(data.CTT_M_KEU);
