            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        if (data[i].PROGRESS_SPPB == "Dalam Proses Chief") {
                            html_progress = '<a href="#" class="btn btn-warning btn-xs block"> ' + data[i].PROGRESS_SPPB + ' </a>';
                            ...
                            html_progress = '<a href="#" class="btn btn-success btn-xs btn-outline block"> ' + data[i].PROGRESS_SPPB;
                        }
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + html_progress + '</td>' +
                            '<td>' +
                            '<a href="<?php echo base_url() ?>SPPB_form/view/' + data[i].HASH_MD5_SPPB + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i> Lihat </a>' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
