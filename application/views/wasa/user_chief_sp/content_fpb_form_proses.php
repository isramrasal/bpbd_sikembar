                        ...
                        <div class="panel-body">
                            <form method="get" class="form-horizontal">
                                ...
                                ?>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Tanggal Aktual Pengajuan</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $FPB->TANGGAL_PENGAJUAN_FPB; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">Tanggal Dokumen</label>
                        ...
                        <div class="form-group"><label class="control-label col-xs-2">Bidang Pemakai</label>
                            <div class="col-xs-2">
                                <select name="BIDANG_PEMAKAI3" class="form-control" id="BIDANG_PEMAKAI3">
                                    <option value="<?php echo $ID_DEPARTEMEN_PEGAWAI; ?>" selected><?php echo $ID_DEPARTEMEN_PEGAWAI; ?></option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="REMARKS_CHIEF5" id="REMARKS_CHIEF5" placeholder="Contoh: " required></textarea>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#mydata').dataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'FPB <?php echo $NO_URUT_FPB  ?>'
                },
                {
                    extend: 'print',
                    title: 'FPB <?php echo $NO_URUT_FPB  ?>',
        ...
        function tampil_data_fpb_form() {
            ...
            $.ajax({ //TOOL
                type: 'GET',
                url: '<?php echo base_url() ?>FPB_form/data_fpb_form_tool',
                async: false,
                dataType: 'json',
                data: {
                    id: ID_FPB
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        let TOTAL_PENGADAAN_SAAT_INI = 0;
                        let html_total_pengadaan = '';
                        let html_rasd = '';
                        ...
                        $.ajax({
                            url: "<?php echo site_url('FPB_form/data_qty_rasd') ?>",
                            type: "POST",
                            dataType: "JSON",
                            async: false,
                            data: form_data_2,
                            success: function(data) {
                                ...
                                if (data_2.length == 0) {
                                    ...
                                    jumlah_rasd = data_2[0].JUMLAH_BARANG;
                        ...
                        jumlah_rasd = parseInt(jumlah_rasd);
                        TOTAL_PENGADAAN_SAAT_INI = parseInt(TOTAL_PENGADAAN_SAAT_INI);

                        if (jumlah_rasd == -100) {
                            html_progress = jumlah_barang + '<br><span class="label label-danger"><i class="fa fa-eject"></i> Item diminta di luar RASD (Deviasi) </span>';
                            html_rasd = '<br><span class="label label-danger"><i class="fa fa-eject"></i> Deviasi</span>';
                            ...
                            if (TOTAL_PENGADAAN_SAAT_INI > (0.5 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-warning"><i class="fa fa-warning"></i> Pengadaan mencapai 50% </span>';
                            } else if (TOTAL_PENGADAAN_SAAT_INI > (0.60 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-warning"><i class="fa fa-warning"></i> Pengadaan mencapai 60% </span>';
                            } else if (TOTAL_PENGADAAN_SAAT_INI > (0.70 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-warning"><i class="fa fa-warning"></i> Pengadaan mencapai 60% </span>';
                            } else if (TOTAL_PENGADAAN_SAAT_INI > (0.80 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-warning"><i class="fa fa-warning"></i> Pengadaan mencapai 60% </span>';
                            } else if (TOTAL_PENGADAAN_SAAT_INI > (0.90 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-warning"><i class="fa fa-warning"></i> Pengadaan mencapai 60% </span>';
                            } else if (TOTAL_PENGADAAN_SAAT_INI > (1.00 * jumlah_rasd)) {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI + '<br><span class="label label-danger"><i class="fa fa-eject"></i> Konsumsi sumber daya melebihi RASD </span>';
                            } else {
                                html_total_pengadaan = TOTAL_PENGADAAN_SAAT_INI;
                            }

                            html_rasd = jumlah_rasd;
            ...
            $.ajax({ //CONSUMABLE
                type: 'GET',
                url: '<?php echo base_url() ?>FPB_form/data_fpb_form_consumable',
                async: false,
                dataType: 'json',
                data: {
                    id: ID_FPB
            ...
            $.ajax({ //MATERIAL
                type: 'GET',
                url: '<?php echo base_url() ?>FPB_form/data_fpb_form_material',
                async: false,
                dataType: 'json',
                data: {
                    id: ID_FPB
            ...
            $.ajax({ //JASA/RENTAL
                type: 'GET',
                url: '<?php echo base_url() ?>FPB_form/data_fpb_form_jasa_rental',
                async: false,
                dataType: 'json',
                data: {
                    id: ID_FPB
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="REMARKS_CHIEF5"]').val(data.REMARKS_CHIEF);
        ...
        $('#btn_update_remarks_barang').on('click', function() {
            ...
            let REMARKS_CHIEF = $('#REMARKS_CHIEF5').val();
            $.ajax({
