...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/wasa/dataTableBaru/dataTables.checkboxes.css">

	<!-- date picker -->
	<link href="<?php echo base_url(); ?>assets/wasa/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/wasa/css/plugins/daterangepicker/daterangepicker-bs3.css" rel="stylesheet">
	...
	<!-- touchspin -->
	<link href="<?php echo base_url(); ?>assets/wasa/css/plugins/touchspin/jquery.bootstrap-touchspin.min.css" rel="stylesheet">
