        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Justifikasi Item Barang/Jasa Staff Logistic</label>
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="JUSTIFIKASI_STAFF_LOG5" id="JUSTIFIKASI_STAFF_LOG5" placeholder="Contoh: " required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (jumlah_barang > jumlah_rasd) {
                            html_progress = '<a href="#" class="btn btn-warning btn-xs block"> ' + jumlah_barang + ' </a><h5>Jumlah yang diminta melebihi RASD</h5>';
                        } else {
                        ...
                        if (data[i].CORET == '1') {
                            html += '<tr>' +
                                ...
                                '<td class="danger"> <strike> 0 </td> </strike>' +
                                '<td class="danger"> <strike> 0 </td> </strike>' +
                                '<td class="danger"> <strike> <span class="label label-warning"><i class="fa fa-warning"></i> Belum ada </span></td> </strike>' +
                                '<td class="danger"> <strike>' + html_progress + '</td> </strike>' +
                                '<td class="danger"> <strike>' + data[i].JUMLAH_SETUJU_CHIEF + '</td> </strike>' +
                                '<td>' +
                                '<a href="javascript:;" class="btn btn-info btn-xs item_batal_coret block" data="' + data[i].ID_SPPB_FORM + '"><i class="fa fa-check"></i> Batal Tolak</a>' + ' ' + data[i].CATATAN_CORET +
                                '<td>' +
                            ...
                            html += '<tr>' +
                                ...
                                '<td>' + html_progress + '</td>' +
                                '<td>' + data[i].JUMLAH_SETUJU_CHIEF + '</td>' +
                                '<td>' +
                                '<a href="javascript:;" class="btn btn-danger btn-xs item_coret block" data="' + data[i].ID_SPPB_FORM + '"><i class="fa fa-ban"></i> Tolak</a>' + ' ' + data[i].CATATAN_BATAL_CORET +
                                '<td>' +
                                '<a href="javascript:;" class="btn btn-success btn-xs item_edit_justifikasi block" data="' + data[i].ID_SPPB_FORM + '"><i class="fa fa-comment  "></i> Justifikasi </a>' + ' ' +
                                '</td>' +
        ...
        $('#btn_update_justifikasi_barang').on('click', function() {
            ...
            let JUSTIFIKASI_STAFF_LOG = $('#JUSTIFIKASI_STAFF_LOG5').val();
            $.ajax({
