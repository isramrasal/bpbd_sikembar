...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <?php if ($PROGRESS_FPB == "Dalam Proses Pembuatan Chief") { ?>
            ...
            <?php if ($PROGRESS_FPB == "Dalam Proses Approval Chief-SM") { ?>
                <a href="<?php echo base_url('index.php/FPB_form/approval/') ?><?php echo $HASH_MD5_FPB; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span> Proses Approval FPB</a>
            <?php
            }
            ?>
