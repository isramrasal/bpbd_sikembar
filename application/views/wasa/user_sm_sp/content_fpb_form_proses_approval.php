        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Kode Master</label>
                        <div class="col-xs-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Remarks Item Barang/Jasa</label>
                        <div class="col-xs-9">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea class="form-control h-200" name="CTT_SM6" id="CTT_SM6" required></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#show_data_approval').on('click', '.item_edit_remarks', function() {
            var id = $(this).attr('data');
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('FPB_form/get_data') ?>",
