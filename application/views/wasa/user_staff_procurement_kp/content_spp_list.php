        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins" id="ibox1">
                ...
                <div class="ibox-content">
                    ...
                    <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#ModalAdd"><span class="fa fa-plus"></span> Buat SPP</a>
                    </br>
                    </br>
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <div class="checkbox i-checks"><label> <input type="checkbox" id="saya_setuju"><i></i> Saya telah selesai melakukan pengisian identitas form SPP ini dan menyetujui untuk melanjutkan proses pengisian item barang/jasa </label></div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#ID_PROYEK_LIST").change(function () {
            ...
            var JUDUL = "List SPP " + NAMA_PROYEK;
            ...
            if (ID_PROYEK == "Semua") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                            ...
                            for (i = 0; i < data_1.length; i++) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        var data_2 = data;
                                        var SPP, NO_URUT_SPPB,NO_URUT_SPPB_baris = '';
                                        ...
                                        if (data_2 == 'TIDAK ADA DATA') {
                                            ...
                                            html +=
                                            '<td>';
                                            SPP =  '<a href="#" class="btn btn-link btn-xs text-decoration-none"> ' + data_1[i].NAMA_PROYEK + ' </a>';
                                            html += SPP + "</br>";
                                            html +=
                                            '</td>';
                                        }
                        ...
                        html_head = '<tr><th>No. SPP</th><th>Proyek</th><th>Pekerjaan</th><th>Tanggal Dokumen SPP</th><th>Status SPP</th></tr>';
                        $('#show_data_head').html(html_head);
                        $('#show_data').html(html);
