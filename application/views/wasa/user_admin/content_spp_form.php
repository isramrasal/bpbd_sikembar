...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <select name="PROGRESS_SPP" class="btn" name="PROGRESS_SPP" id="PROGRESS_SPP">
                <option value='<?php echo $PROGRESS_SPP; ?>'><?php echo $PROGRESS_SPP; ?></option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#PROGRESS_SPP").change(function () {

            var PROGRESS_SPP = $('[name="PROGRESS_SPP"]').val();
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>/SPP_form/update_progress",
                method: "POST",
                data: form_data,
                async: false,
                dataType: 'json',
