...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <a href="<?php echo base_url('index.php/PO_form/pengajuan_vendor/') ?><?php echo $HASH_MD5_PO; ?>" class="btn btn-primary"><span class="fa fa-book"></span> Lihat Harga Pengajuan Vendor</a><br>
            <select name="PROGRESS_PO" class="btn" name="PROGRESS_PO" id="PROGRESS_PO">
                <option value='<?php echo $PROGRESS_PO; ?>'> <?php echo $PROGRESS_PO; ?> </option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#PROGRESS_PO").change(function () {

            var PROGRESS_PO = $('[name="PROGRESS_PO"]').val();
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>/PO_form/update_progress",
                method: "POST",
                data: form_data,
                async: false,
                dataType: 'json',
