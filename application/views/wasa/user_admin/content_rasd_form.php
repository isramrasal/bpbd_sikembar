                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="mydata">
                            ...
                            <tbody id="show_data">
                                ...
                                <a href="#" class="btn btn-primary " data-toggle="modal" data-target="#ModalaAddTanpaBarangMaster"><span class="fa fa-plus"></span> Tambah Data Di Luar Barang Master</a>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            ?>
                <div class="modal-header">
                    ...
                    <b class="font-bold">Maaf semua barang master sudah ada di RASD form ini</b>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close"></i> Batal</button>
                </div>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="form-horizontal">
                <div class="modal-body">
                    ...
                    <input name="ID_BARANG_MASTER2" id="ID_BARANG_MASTER2" class="form-control" placeholder="Barang belum ada di barang master" type="hidden" readonly>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (kode_barang != null) {
                            kode_barang_cetak = '<a href="<?php echo base_url() ?>barang_master/profil_barang_master/'+data[i].HASH_MD5_BARANG_MASTER +'" class="btn btn-warning btn-xs btn-outline block"><i class="fa fa-eye"></i> '+ kode_barang +' </a>';
                        }
                        if (kode_barang == null) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + jumlah_barang + '</td>' +
                            '<td>' +
                            '<a href="javascript:;" class="btn btn-info btn-xs item_edit block" data="' + data[i].ID_RASD_FORM + '"><i class="fa fa-pencil"></i> Edit </a>' + ' ' +
