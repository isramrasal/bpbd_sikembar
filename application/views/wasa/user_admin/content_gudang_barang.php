				...
				success: function(data) {
					...
					for (i = 0; i < data.length; i++) {
						html += '<tr>' +
							...
							'<a href="<?php echo base_url() ?>Riwayat_pemakaian_barang_entitas/index/' + data[i].HASH_MD5_BARANG_ENTITAS + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i>Riwayat Pemakaian Barang</a>' +
							'<a href="<?php echo base_url() ?>Riwayat_perbaikan_barang_entitas/index/' + data[i].HASH_MD5_BARANG_ENTITAS + '" class="btn btn-info btn-xs block"><i class="fa fa-eye"></i>Riwayat Perbaikan Barang</a>' +
							'</td>' +
