...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="alert alert-info alert-dismissable">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
        Sistem menampilkan seluruh FISTB yang pada proyek di Kantor Pusat dan Kantor Lapangan.
    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            $('[name="ID_PROYEK_SUB_PEKERJAAN"]').val(data[i].ID_PROYEK_SUB_PEKERJAAN);
                            $('[name="ID_SPPB"]').val(data[i].ID_SPPB);
                            $('[name="ID_SPP"]').val(data[i].ID_SPP);
                            $('[name="ID_PO"]').val(data[i].ID_PO);
                            $('[name="ID_VENDOR"]').val(data[i].ID_VENDOR);
                            $('[name="LOKASI_PENYERAHAN"]').val(data[i].LOKASI_PENYERAHAN);
                        }
