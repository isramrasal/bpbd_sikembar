	...
	<div class="modal-dialog">
		<div class="modal-content animated bounceInRight">
			<div class="modal-header">
				...
				<small class="font-bold">Silakan tambah data riwayat_perbaikan_barang</small>
			</div>
			<?php $attributes = array("name" => "contact_form", "id" => "contact_form");
			echo form_open("riwayat_perbaikan_barang/simpan_data", $attributes); ?>
...
<div class="modal inmodal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content animated bounceInRight">
			...
			echo form_open("riwayat_perbaikan_barang/update_data", $attributes); ?>
			<div class="form-horizontal">
				<div class="modal-body">
...
<script>
	$(document).ready(function() {
		...
		function tampil_data_riwayat_perbaikan_barang() {
			$.ajax({
				type: 'ajax',
				url: '<?php echo base_url() ?>index.php/riwayat_perbaikan_barang/data_riwayat_perbaikan_barang',
				async: false,
				dataType: 'json',
		...
		$('#show_data').on('click', '.item_edit', function() {
			...
			$.ajax({
				type: "GET",
				url: "<?php echo base_url('index.php/riwayat_perbaikan_barang/get_data') ?>",
				dataType: "JSON",
				data: {
					id: id
				},
		...
		$('#btn_simpan').click(function() {
			...
			$.ajax({
				url: "<?php echo site_url('riwayat_perbaikan_barang/simpan_data'); ?>",
				type: 'POST',
				data: form_data,
				success: function(data) {
					if (data != '') {
		...
		$('#btn_update').on('click', function() {
			...
			$.ajax({
				url: "<?php echo site_url('riwayat_perbaikan_barang/update_data') ?>",
				type: "POST",
				dataType: "JSON",
				data: {
		...
		$('#btn_hapus').on('click', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/riwayat_perbaikan_barang/hapus_data') ?>",
				dataType: "JSON",
				data: {
					kode: kode
				},
