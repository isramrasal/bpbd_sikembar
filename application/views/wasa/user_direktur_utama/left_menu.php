					...
					<?php if ($left_menu == "dashboard_direktur_utama_aktif") { ?>
						<li class="active">
							<a href="<?php echo base_url(); ?>index.php/Dashboard_direktur_utama"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span> </a>
						</li>
					<?php } else { ?>
						<li>
							<a href="<?php echo base_url(); ?>index.php/Dashboard_direktur_utama"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span> </a>
