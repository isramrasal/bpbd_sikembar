<?php
class Quotation_Form_Alternatif_model extends CI_Model
{
	...
	function rfq_form_list_by_id_rfq($ID_RFQ)
	{
		...
		rfq_form.NAMA_BARANG, rfq_form.MEREK, rfq_form.PERALATAN_PERLENGKAPAN, 
	...
	{
		$hsl = $this->db->query("SELECT NAMA_BARANG AS NAMA FROM quotation_form_alternatif WHERE NAMA_BARANG ='$NAMA' AND ID_RFQ ='$ID_RFQ' ");
		if ($hsl->num_rows() > 0) {
